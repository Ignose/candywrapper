...
function getCurrentSession() {
  ...
  */
  ...
  for (var _i2 = 0, _arr2 = [external_kolmafia_namespaceObject.getCloset, external_kolmafia_namespaceObject.getStorage, external_kolmafia_namespaceObject.getShop]; _i2 < _arr2.length; _i2++) {
...
function CSQuests() {
  return [{
    ...
    tasks: [{
      ...
      completed: () => !canPlay(template_string_$item(csrunleg_templateObject71 || (csrunleg_templateObject71 = csrunleg_taggedTemplateLiteral(["Apriling band piccolo"])))),
      do: () => {
        joinSection(template_string_$item(csrunleg_templateObject72 || (csrunleg_templateObject72 = csrunleg_taggedTemplateLiteral(["Apriling band piccolo"]))));
        if (canJoinSection()) {
          joinSection(template_string_$item(csrunleg_templateObject73 || (csrunleg_templateObject73 = csrunleg_taggedTemplateLiteral(["Apriling band saxophone"]))));
          play(template_string_$item(csrunleg_templateObject74 || (csrunleg_templateObject74 = csrunleg_taggedTemplateLiteral(["Apriling band saxophone"]))));
        }
        if (lib_have(template_string_$familiar(csrunleg_templateObject75 || (csrunleg_templateObject75 = csrunleg_taggedTemplateLiteral(["Grey Goose"]))))) (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(csrunleg_templateObject76 || (csrunleg_templateObject76 = csrunleg_taggedTemplateLiteral(["Grey Goose"]))));else if (lib_have(template_string_$familiar(_templateObject77 || (_templateObject77 = csrunleg_taggedTemplateLiteral(["Chest Mimic"]))))) (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject78 || (_templateObject78 = csrunleg_taggedTemplateLiteral(["Chest Mimic"]))));else if (lib_have(template_string_$familiar(_templateObject79 || (_templateObject79 = csrunleg_taggedTemplateLiteral(["Pocket Professor"])))) && (0,external_kolmafia_namespaceObject.familiarWeight)(template_string_$familiar(_templateObject80 || (_templateObject80 = csrunleg_taggedTemplateLiteral(["Pocket Professor"])))) < 20) (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject81 || (_templateObject81 = csrunleg_taggedTemplateLiteral(["Pocket Professor"]))));else if (lib_have(template_string_$familiar(_templateObject82 || (_templateObject82 = csrunleg_taggedTemplateLiteral(["Comma Chameleon"]))))) (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject83 || (_templateObject83 = csrunleg_taggedTemplateLiteral(["Comma Chameleon"]))));
        while (template_string_$item(_templateObject84 || (_templateObject84 = csrunleg_taggedTemplateLiteral(["Apriling band piccolo"]))).dailyusesleft > 0 && lib_have(template_string_$item(_templateObject85 || (_templateObject85 = csrunleg_taggedTemplateLiteral(["Apriling band piccolo"]))))) play(template_string_$item(_templateObject86 || (_templateObject86 = csrunleg_taggedTemplateLiteral(["Apriling band piccolo"]))));
      },
      limit: {
        tries: 1
      }
      ...
      name: "Pajamas",
      completed: () => lib_have(template_string_$item(_templateObject87 || (_templateObject87 = csrunleg_taggedTemplateLiteral(["burning cape"])))),
      acquire: [{
        item: template_string_$item(_templateObject88 || (_templateObject88 = csrunleg_taggedTemplateLiteral(["clockwork maid"]))),
        price: 7 * property_get("valueOfAdventure"),
        optional: true
      }, {
        item: template_string_$item(_templateObject89 || (_templateObject89 = csrunleg_taggedTemplateLiteral(["burning cape"])))
      }],
      do: () => {
        if (lib_have(template_string_$item(_templateObject90 || (_templateObject90 = csrunleg_taggedTemplateLiteral(["clockwork maid"]))))) {
          (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject91 || (_templateObject91 = csrunleg_taggedTemplateLiteral(["clockwork maid"]))));
        }
...
function AftercoreQuest() {
  return {
    ...
    tasks: [{
      ...
      name: "Plant Grass",
      completed: () => !lib_have(template_string_$item(aftercoreleg_templateObject9 || (aftercoreleg_templateObject9 = aftercoreleg_taggedTemplateLiteral(["packet of tall grass seeds"])))) || getGarden() === template_string_$item(aftercoreleg_templateObject10 || (aftercoreleg_templateObject10 = aftercoreleg_taggedTemplateLiteral(["packet of tall grass seeds"]))),
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(aftercoreleg_templateObject11 || (aftercoreleg_templateObject11 = aftercoreleg_taggedTemplateLiteral(["packet of tall grass seeds"]))))
    }, {
      name: "SIT Course",
      // eslint-disable-next-line libram/verify-constants
      ready: () => lib_have(template_string_$item(aftercoreleg_templateObject12 || (aftercoreleg_templateObject12 = aftercoreleg_taggedTemplateLiteral(["S.I.T. Course Completion Certificate"])))),
      ...
      do: () =>
      // eslint-disable-next-line libram/verify-constants
      (0,external_kolmafia_namespaceObject.use)(template_string_$item(aftercoreleg_templateObject13 || (aftercoreleg_templateObject13 = aftercoreleg_taggedTemplateLiteral(["S.I.T. Course Completion Certificate"]))))
    }, {
      name: "Drive Observantly",
      completed: () => property_get("dailyDungeonDone") || (0,external_kolmafia_namespaceObject.getWorkshed)() !== template_string_$item(aftercoreleg_templateObject14 || (aftercoreleg_templateObject14 = aftercoreleg_taggedTemplateLiteral(["Asdon Martin keyfob (on ring)"]))) || (0,external_kolmafia_namespaceObject.haveEffect)(template_string_$effect(aftercoreleg_templateObject15 || (aftercoreleg_templateObject15 = aftercoreleg_taggedTemplateLiteral(["Driving Observantly"])))) >= (totallyDrunk() || !lib_have(template_string_$item(aftercoreleg_templateObject16 || (aftercoreleg_templateObject16 = aftercoreleg_taggedTemplateLiteral(["Drunkula's wineglass"])))) ? (0,external_kolmafia_namespaceObject.myAdventures)() : (0,external_kolmafia_namespaceObject.myAdventures)() + 60),
      do: () => drive(template_string_$effect(aftercoreleg_templateObject17 || (aftercoreleg_templateObject17 = aftercoreleg_taggedTemplateLiteral(["Driving Observantly"]))), totallyDrunk() || !lib_have(template_string_$item(aftercoreleg_templateObject18 || (aftercoreleg_templateObject18 = aftercoreleg_taggedTemplateLiteral(["Drunkula's wineglass"])))) ? (0,external_kolmafia_namespaceObject.myAdventures)() : (0,external_kolmafia_namespaceObject.myAdventures)() + 60, false),
      limit: {
        tries: 5
      }
    }, {
      name: "Sample Constellation DNA",
      ready: () => lib_have(template_string_$item(aftercoreleg_templateObject19 || (aftercoreleg_templateObject19 = aftercoreleg_taggedTemplateLiteral(["DNA extraction syringe"])))),
      completed: () => !DNALab_installed() || isHybridized($phylum(aftercoreleg_templateObject20 || (aftercoreleg_templateObject20 = aftercoreleg_taggedTemplateLiteral(["Constellation"])))) || property_get("dnaSyringe") === $phylum(aftercoreleg_templateObject21 || (aftercoreleg_templateObject21 = aftercoreleg_taggedTemplateLiteral(["Constellation"]))),
      outfit: {
        familiar: bestFam(),
        modifier: "".concat(maxBase())
      },
      do: $location(aftercoreleg_templateObject22 || (aftercoreleg_templateObject22 = aftercoreleg_taggedTemplateLiteral(["The Hole in the Sky"]))),
      combat: new CombatStrategy().macro(Macro.skill(template_string_$skill(aftercoreleg_templateObject23 || (aftercoreleg_templateObject23 = aftercoreleg_taggedTemplateLiteral(["Curse of Weaksauce"])))), getTodaysHolidayWanderers()).macro(Macro.tryItem(template_string_$item(aftercoreleg_templateObject24 || (aftercoreleg_templateObject24 = aftercoreleg_taggedTemplateLiteral(["DNA extraction syringe"]))))).macro(Macro.tryItem(template_string_$item(aftercoreleg_templateObject25 || (aftercoreleg_templateObject25 = aftercoreleg_taggedTemplateLiteral(["train whistle"])))).tryItem(template_string_$item(aftercoreleg_templateObject26 || (aftercoreleg_templateObject26 = aftercoreleg_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill(template_string_$skill(aftercoreleg_templateObject27 || (aftercoreleg_templateObject27 = aftercoreleg_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
    }, {
      name: "Hybridize Constellation",
      ready: () => property_get("dnaSyringe") === $phylum(aftercoreleg_templateObject28 || (aftercoreleg_templateObject28 = aftercoreleg_taggedTemplateLiteral(["Constellation"]))),
      completed: () => !DNALab_installed() || isHybridized($phylum(aftercoreleg_templateObject29 || (aftercoreleg_templateObject29 = aftercoreleg_taggedTemplateLiteral(["Constellation"])))),
      do: () => {
        makeTonic(3);
        hybridize();
      }
      ...
      isGoodGarboScript(args.garboascend) || args.pulls.includes(template_string_$item(aftercoreleg_templateObject30 || (aftercoreleg_templateObject30 = aftercoreleg_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
      completed: () => !lib_have(template_string_$item(aftercoreleg_templateObject31 || (aftercoreleg_templateObject31 = aftercoreleg_taggedTemplateLiteral(["lucky gold ring"])))) || property_get("_stenchAirportToday") || property_get("stenchAirportAlways"),
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(aftercoreleg_templateObject32 || (aftercoreleg_templateObject32 = aftercoreleg_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"]))))
    }, {
      name: "June Cleaver",
      completed: () => !lib_have(template_string_$item(aftercoreleg_templateObject33 || (aftercoreleg_templateObject33 = aftercoreleg_taggedTemplateLiteral(["June cleaver"])))) || property_get("_juneCleaverFightsLeft") > 0 || (0,external_kolmafia_namespaceObject.myAdventures)() === 0,
      choices: {
        1467: 3,
        //Poetic Justice
      ...
      do: $location(aftercoreleg_templateObject34 || (aftercoreleg_templateObject34 = aftercoreleg_taggedTemplateLiteral(["Noob Cave"]))),
      post: () => {
        if ((0,external_kolmafia_namespaceObject.handlingChoice)()) (0,external_kolmafia_namespaceObject.visitUrl)("main.php");
        if (lib_have(template_string_$effect(aftercoreleg_templateObject35 || (aftercoreleg_templateObject35 = aftercoreleg_taggedTemplateLiteral(["Beaten Up"]))))) uneffect(template_string_$effect(aftercoreleg_templateObject36 || (aftercoreleg_templateObject36 = aftercoreleg_taggedTemplateLiteral(["Beaten Up"]))));
      },
      outfit: () => ({
        equip: template_string_$items(aftercoreleg_templateObject37 || (aftercoreleg_templateObject37 = aftercoreleg_taggedTemplateLiteral(["June cleaver"])))
      }),
      limit: undefined
    }, {
      name: "Restore HP",
      ...
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(aftercoreleg_templateObject39 || (aftercoreleg_templateObject39 = aftercoreleg_taggedTemplateLiteral(["[glitch season reward name]"]))))
    }, {
      name: "Fight Glitch",
      ...
      acquire: template_string_$items(aftercoreleg_templateObject41 || (aftercoreleg_templateObject41 = aftercoreleg_taggedTemplateLiteral(["gas can, gas balloon, shard of double-ice"]))).map(it => ({
        item: it,
        price: 1000
      })),
      prepare: () => {
        (0,external_kolmafia_namespaceObject.restoreHp)(0.9 * (0,external_kolmafia_namespaceObject.myMaxhp)());
        if (lib_have(template_string_$skill(aftercoreleg_templateObject42 || (aftercoreleg_templateObject42 = aftercoreleg_taggedTemplateLiteral(["Blood Bubble"])))) && !lib_have(template_string_$effect(aftercoreleg_templateObject43 || (aftercoreleg_templateObject43 = aftercoreleg_taggedTemplateLiteral(["Blood Bubble"]))))) (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(aftercoreleg_templateObject44 || (aftercoreleg_templateObject44 = aftercoreleg_taggedTemplateLiteral(["Blood Bubble"]))));
      },
      ...
      combat: new CombatStrategy().macro(() => {
        ...
        return (_Macro$tryItem$trySki = Macro.tryItem(template_string_$item(aftercoreleg_templateObject45 || (aftercoreleg_templateObject45 = aftercoreleg_taggedTemplateLiteral(["gas balloon"])))).trySkill(template_string_$skill(aftercoreleg_templateObject46 || (aftercoreleg_templateObject46 = aftercoreleg_taggedTemplateLiteral(["Feel Pride"]))))).tryItem.apply(_Macro$tryItem$trySki, aftercoreleg_toConsumableArray(template_string_$items(aftercoreleg_templateObject47 || (aftercoreleg_templateObject47 = aftercoreleg_taggedTemplateLiteral(["shard of double-ice, gas can"]))))).attack().repeat();
      }),
      tracking: "Leveling"
    }, {
      name: "Unlock Guild",
      ready: () => (0,external_kolmafia_namespaceObject.myClass)() === $class(aftercoreleg_templateObject48 || (aftercoreleg_templateObject48 = aftercoreleg_taggedTemplateLiteral(["Seal Clubber"]))) && Math.min.apply(Math, aftercoreleg_toConsumableArray(template_string_$items(aftercoreleg_templateObject49 || (aftercoreleg_templateObject49 = aftercoreleg_taggedTemplateLiteral(["figurine of a wretched-looking seal, seal-blubber candle"]))).map(it => (0,external_kolmafia_namespaceObject.availableAmount)(it)))) < 20 && doSmol,
      ...
      outfit: () => ({
        familiar: bestFam(),
        modifier: "".concat(maxBase(), ", ").concat((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(aftercoreleg_templateObject50 || (aftercoreleg_templateObject50 = aftercoreleg_taggedTemplateLiteral(["Muscle"]))) ? "100 combat rate 20 max" : "-100 combat rate", ", 250 bonus carnivorous potted plant")
      }),
      combat: new CombatStrategy().macro(() => Macro.step("pickpocket").externalIf(lib_have(template_string_$skill(aftercoreleg_templateObject51 || (aftercoreleg_templateObject51 = aftercoreleg_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.trySkill(template_string_$skill(aftercoreleg_templateObject52 || (aftercoreleg_templateObject52 = aftercoreleg_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.tryItem(template_string_$item(aftercoreleg_templateObject53 || (aftercoreleg_templateObject53 = aftercoreleg_taggedTemplateLiteral(["electronics kit"]))))).tryItem(template_string_$item(aftercoreleg_templateObject54 || (aftercoreleg_templateObject54 = aftercoreleg_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill(template_string_$skill(aftercoreleg_templateObject55 || (aftercoreleg_templateObject55 = aftercoreleg_taggedTemplateLiteral(["Sing Along"])))).attack().repeat(), getTodaysHolidayWanderers()).macro(() => Macro.step("pickpocket").trySkill(template_string_$skill(aftercoreleg_templateObject56 || (aftercoreleg_templateObject56 = aftercoreleg_taggedTemplateLiteral(["Sing Along"])))).tryItem(template_string_$item(aftercoreleg_templateObject57 || (aftercoreleg_templateObject57 = aftercoreleg_taggedTemplateLiteral(["porquoise-handled sixgun"])))).attack().repeat())
    }, {
      name: "Stock Up on MMJs",
      ready: () => (0,external_kolmafia_namespaceObject.guildStoreAvailable)() && ((0,external_kolmafia_namespaceObject.myClass)().primestat === $stat(aftercoreleg_templateObject58 || (aftercoreleg_templateObject58 = aftercoreleg_taggedTemplateLiteral(["Mysticality"]))) || (0,external_kolmafia_namespaceObject.myClass)() === $class(aftercoreleg_templateObject59 || (aftercoreleg_templateObject59 = aftercoreleg_taggedTemplateLiteral(["Accordion Thief"]))) && (0,external_kolmafia_namespaceObject.myLevel)() >= 9),
      completed: () => (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(aftercoreleg_templateObject60 || (aftercoreleg_templateObject60 = aftercoreleg_taggedTemplateLiteral(["magical mystery juice"])))) >= 500,
      acquire: [{
        item: template_string_$item(aftercoreleg_templateObject61 || (aftercoreleg_templateObject61 = aftercoreleg_taggedTemplateLiteral(["magical mystery juice"]))),
        num: 500
      }],
      do: () => false
    }, {
      name: "Buy Seal Summoning Supplies",
      ready: () => (0,external_kolmafia_namespaceObject.myClass)() === $class(aftercoreleg_templateObject62 || (aftercoreleg_templateObject62 = aftercoreleg_taggedTemplateLiteral(["Seal Clubber"]))) && (0,external_kolmafia_namespaceObject.guildStoreAvailable)(),
      completed: () => Math.min.apply(Math, aftercoreleg_toConsumableArray(template_string_$items(aftercoreleg_templateObject63 || (aftercoreleg_templateObject63 = aftercoreleg_taggedTemplateLiteral(["figurine of a wretched-looking seal, seal-blubber candle"]))).map(it => (0,external_kolmafia_namespaceObject.availableAmount)(it)))) >= 40,
      acquire: template_string_$items(aftercoreleg_templateObject64 || (aftercoreleg_templateObject64 = aftercoreleg_taggedTemplateLiteral(["figurine of a wretched-looking seal, seal-blubber candle"]))).map(it => ({
        item: it,
        num: 500
      })),
      do: () => false
      ...
      prepare: () => uneffect(template_string_$effect(aftercoreleg_templateObject65 || (aftercoreleg_templateObject65 = aftercoreleg_taggedTemplateLiteral(["Beaten Up"])))),
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)(args.garboascend),
      post: () => {
        if ((0,external_kolmafia_namespaceObject.myAdventures)() === 0) $effects(aftercoreleg_templateObject66 || (aftercoreleg_templateObject66 = aftercoreleg_taggedTemplateLiteral(["Power Ballad of the Arrowsmith, Stevedave's Shanty of Superiority, The Moxious Madrigal, The Magical Mojomuscular Melody, Aloysius' Antiphon of Aptitude, Ur-Kel's Aria of Annoyance"]))).filter(ef => lib_have(ef)).forEach(ef => uneffect(ef));
      },
      clear: "all",
      tracking: "Garbo",
      limit: {
      ...
      name: "Stooper",
      ready: () => (0,external_kolmafia_namespaceObject.myInebriety)() === (0,external_kolmafia_namespaceObject.inebrietyLimit)() && lib_have(template_string_$item(aftercoreleg_templateObject67 || (aftercoreleg_templateObject67 = aftercoreleg_taggedTemplateLiteral(["tiny stillsuit"])))) && property_get("familiarSweat") >= 300,
      completed: () => !lib_have(template_string_$familiar(aftercoreleg_templateObject68 || (aftercoreleg_templateObject68 = aftercoreleg_taggedTemplateLiteral(["Stooper"])))) || stooperDrunk(),
      do: () => {
        (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(aftercoreleg_templateObject69 || (aftercoreleg_templateObject69 = aftercoreleg_taggedTemplateLiteral(["Stooper"]))));
        (0,external_kolmafia_namespaceObject.cliExecute)("drink stillsuit distillate");
      }
    }, {
      name: "Barfing Drunk with Stooper",
      ready: () => stooperDrunk() && lib_have(template_string_$familiar(aftercoreleg_templateObject70 || (aftercoreleg_templateObject70 = aftercoreleg_taggedTemplateLiteral(["Stooper"])))) && !lib_have(template_string_$item(aftercoreleg_templateObject71 || (aftercoreleg_templateObject71 = aftercoreleg_taggedTemplateLiteral(["Drunkula's wineglass"])))),
      completed: () => (0,external_kolmafia_namespaceObject.myAdventures)() === 0 || totallyDrunk(),
      acquire: [{
        item: template_string_$item(aftercoreleg_templateObject72 || (aftercoreleg_templateObject72 = aftercoreleg_taggedTemplateLiteral(["seal tooth"])))
      }],
      outfit: () => ({
        familiar: template_string_$familiar(aftercoreleg_templateObject73 || (aftercoreleg_templateObject73 = aftercoreleg_taggedTemplateLiteral(["Stooper"]))),
        modifier: "".concat(maxBase(), ", 2.5 meat, 0.6 items")
      }),
      effects: $effects(aftercoreleg_templateObject74 || (aftercoreleg_templateObject74 = aftercoreleg_taggedTemplateLiteral(["How to Scam Tourists"]))),
      ...
      do: $location(aftercoreleg_templateObject75 || (aftercoreleg_templateObject75 = aftercoreleg_taggedTemplateLiteral(["Barf Mountain"]))),
      combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(aftercoreleg_templateObject76 || (aftercoreleg_templateObject76 = aftercoreleg_taggedTemplateLiteral(["Curse of Weaksauce"])))), getTodaysHolidayWanderers()).macro(() => Macro.step("pickpocket").tryItem(template_string_$item(aftercoreleg_templateObject77 || (aftercoreleg_templateObject77 = aftercoreleg_taggedTemplateLiteral(["train whistle"])))).trySkill(template_string_$skill(aftercoreleg_templateObject78 || (aftercoreleg_templateObject78 = aftercoreleg_taggedTemplateLiteral(["Bowl Straight Up"])))).trySkill(template_string_$skill(aftercoreleg_templateObject79 || (aftercoreleg_templateObject79 = aftercoreleg_taggedTemplateLiteral(["Sing Along"])))).tryItem(template_string_$item(aftercoreleg_templateObject80 || (aftercoreleg_templateObject80 = aftercoreleg_taggedTemplateLiteral(["porquoise-handled sixgun"])))).externalIf((0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(aftercoreleg_templateObject81 || (aftercoreleg_templateObject81 = aftercoreleg_taggedTemplateLiteral(["mafia pointer finger ring"])))), Macro.trySkill(template_string_$skill(aftercoreleg_templateObject82 || (aftercoreleg_templateObject82 = aftercoreleg_taggedTemplateLiteral(["Furious Wallop"])))).trySkill(template_string_$skill(aftercoreleg_templateObject83 || (aftercoreleg_templateObject83 = aftercoreleg_taggedTemplateLiteral(["Summer Siesta"])))).trySkill(template_string_$skill(aftercoreleg_templateObject84 || (aftercoreleg_templateObject84 = aftercoreleg_taggedTemplateLiteral(["Throw Shield"])))).trySkill(template_string_$skill(aftercoreleg_templateObject85 || (aftercoreleg_templateObject85 = aftercoreleg_taggedTemplateLiteral(["Precision Shot"]))))).attack().repeat()),
      limit: {
        tries: 30
      }
    }, {
      name: "Nightcap (Wine Glass)",
      ready: () => lib_have(template_string_$item(aftercoreleg_templateObject86 || (aftercoreleg_templateObject86 = aftercoreleg_taggedTemplateLiteral(["Drunkula's wineglass"])))),
      completed: () => totallyDrunk(),
      ...
      ready: () => lib_have(template_string_$item(aftercoreleg_templateObject87 || (aftercoreleg_templateObject87 = aftercoreleg_taggedTemplateLiteral(["Beach Comb"])))) || lib_have(template_string_$item(aftercoreleg_templateObject88 || (aftercoreleg_templateObject88 = aftercoreleg_taggedTemplateLiteral(["Map to Safety Shelter Grimace Prime"])))),
      completed: () => totallyDrunk(),
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("CONSUME NIGHTCAP VALUE 500")
    }, {
      name: "Grimace Maps",
      completed: () => (0,external_kolmafia_namespaceObject.myAdventures)() === 0 || !lib_have(template_string_$item(aftercoreleg_templateObject89 || (aftercoreleg_templateObject89 = aftercoreleg_taggedTemplateLiteral(["Map to Safety Shelter Grimace Prime"])))),
      ...
      name: "Garbo (Drunk)",
      ready: () => lib_have(template_string_$item(aftercoreleg_templateObject90 || (aftercoreleg_templateObject90 = aftercoreleg_taggedTemplateLiteral(["Drunkula's wineglass"])))),
      prepare: () => uneffect(template_string_$effect(aftercoreleg_templateObject91 || (aftercoreleg_templateObject91 = aftercoreleg_taggedTemplateLiteral(["Beaten Up"])))),
      ...
      post: () => $effects(_templateObject92 || (_templateObject92 = aftercoreleg_taggedTemplateLiteral(["Power Ballad of the Arrowsmith, Stevedave's Shanty of Superiority, The Moxious Madrigal, The Magical Mojomuscular Melody, Aloysius' Antiphon of Aptitude, Ur-Kel's Aria of Annoyance"]))).filter(ef => lib_have(ef)).forEach(ef => uneffect(ef)),
      clear: "all",
      tracking: "Garbo"
    }, {
      name: "Comb Beach",
      ready: () => lib_have(template_string_$item(_templateObject93 || (_templateObject93 = aftercoreleg_taggedTemplateLiteral(["Beach Comb"])))),
      completed: () => (0,external_kolmafia_namespaceObject.myAdventures)() === 0,
      ...
      name: "Turn in FunFunds",
      ready: () => property_get("_stenchAirportToday") && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject94 || (_templateObject94 = aftercoreleg_taggedTemplateLiteral(["FunFunds\u2122"])))) >= 20,
      completed: () => lib_have(template_string_$item(_templateObject95 || (_templateObject95 = aftercoreleg_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
      do: () => (0,external_kolmafia_namespaceObject.buy)($coinmaster(_templateObject96 || (_templateObject96 = aftercoreleg_taggedTemplateLiteral(["The Dinsey Company Store"]))), 1, template_string_$item(_templateObject97 || (_templateObject97 = aftercoreleg_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
      tracking: "Garbo"
    }, {
      name: "PvP",
      completed: () => (0,external_kolmafia_namespaceObject.pvpAttacksLeft)() === 0 || !(0,external_kolmafia_namespaceObject.hippyStoneBroken)(),
      ...
      ready: () => doSmol,
      completed: () => lib_have(template_string_$item(_templateObject98 || (_templateObject98 = aftercoreleg_taggedTemplateLiteral(["Pizza of Legend"])))) && lib_have(template_string_$item(_templateObject99 || (_templateObject99 = aftercoreleg_taggedTemplateLiteral(["Frosty's frosty mug"])))) && lib_have(template_string_$item(_templateObject100 || (_templateObject100 = aftercoreleg_taggedTemplateLiteral(["Ol' Scratch's salad fork"])))),
      do: () => {
        if ((0,external_kolmafia_namespaceObject.mallPrice)(template_string_$item(_templateObject101 || (_templateObject101 = aftercoreleg_taggedTemplateLiteral(["Frosty's frosty mug"])))) < 200000 && (0,external_kolmafia_namespaceObject.mallPrice)(template_string_$item(_templateObject102 || (_templateObject102 = aftercoreleg_taggedTemplateLiteral(["Ol' Scratch's salad fork"])))) < 200000) (0,external_kolmafia_namespaceObject.cliExecute)("acquire Pizza of Legend; acquire Frosty's frosty mug; acquire Ol' Scratch's salad fork");
      }
    }, {
      name: "Marble Soda!",
      ready: () => doCS,
      completed: () => lib_have(template_string_$item(_templateObject103 || (_templateObject103 = aftercoreleg_taggedTemplateLiteral(["tobiko marble soda"])))) || (0,external_kolmafia_namespaceObject.mallPrice)(template_string_$item(_templateObject104 || (_templateObject104 = aftercoreleg_taggedTemplateLiteral(["tobiko marble soda"])))) > property_get("valueOfAdventure") * 2,
      do: () => {
        (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(_templateObject105 || (_templateObject105 = aftercoreleg_taggedTemplateLiteral(["tobiko marble soda"]))));
      }
    }, {
      ...
      completed: () => {
        ...
        if (!lib_have(template_string_$familiar(_templateObject106 || (_templateObject106 = aftercoreleg_taggedTemplateLiteral(["Comma Chameleon"]))))) return true;
        if (lib_have(template_string_$familiar(_templateObject107 || (_templateObject107 = aftercoreleg_taggedTemplateLiteral(["Frumious Bandersnatch"])))) || lib_have(template_string_$familiar(_templateObject108 || (_templateObject108 = aftercoreleg_taggedTemplateLiteral(["Pair of Stomping Boots"]))))) return true;
        if (template_string_$items(_templateObject109 || (_templateObject109 = aftercoreleg_taggedTemplateLiteral(["aquaviolet jub-jub bird, charpuce jub-jub bird, crimsilion jub-jub bird, stomp box"]))).find(f => lib_have(f))) return true;
      ...
      completed: () => lib_have(template_string_$item(_templateObject110 || (_templateObject110 = aftercoreleg_taggedTemplateLiteral(["Pizza of Legend"])))) && lib_have(template_string_$item(_templateObject111 || (_templateObject111 = aftercoreleg_taggedTemplateLiteral(["Deep Dish of Legend"])))) && lib_have(template_string_$item(_templateObject112 || (_templateObject112 = aftercoreleg_taggedTemplateLiteral(["Calzone of Legend"])))),
      do: () => {
        !lib_have(template_string_$item(_templateObject113 || (_templateObject113 = aftercoreleg_taggedTemplateLiteral(["Pizza of Legend"])))) ? (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(_templateObject114 || (_templateObject114 = aftercoreleg_taggedTemplateLiteral(["Pizza of Legend"])))) : undefined;
        !lib_have(template_string_$item(_templateObject115 || (_templateObject115 = aftercoreleg_taggedTemplateLiteral(["Deep Dish of Legend"])))) ? (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(_templateObject116 || (_templateObject116 = aftercoreleg_taggedTemplateLiteral(["Deep Dish of Legend"])))) : undefined;
        !lib_have(template_string_$item(_templateObject117 || (_templateObject117 = aftercoreleg_taggedTemplateLiteral(["Calzone of Legend"])))) ? (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(_templateObject118 || (_templateObject118 = aftercoreleg_taggedTemplateLiteral(["Calzone of Legend"])))) : undefined;
        !lib_have(template_string_$item(_templateObject119 || (_templateObject119 = aftercoreleg_taggedTemplateLiteral(["borrowed time"])))) ? (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(_templateObject120 || (_templateObject120 = aftercoreleg_taggedTemplateLiteral(["borrowed time"])))) : undefined;
      }
    }, {
...
function SmolQuests() {
  return [{
    ...
    tasks: [{
      ...
      do: () => {
        (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject121 || (_templateObject121 = smolrunleg_taggedTemplateLiteral(["Stooper"]))));
        (0,external_kolmafia_namespaceObject.cliExecute)("drink stillsuit distillate");
      }
    }, {
      name: "Nightcap",
      ...
      name: "Smoke em if you got em",
      completed: () => !lib_have(template_string_$item(_templateObject122 || (_templateObject122 = smolrunleg_taggedTemplateLiteral(["stick of firewood"])))),
      do: () => {
        while (lib_have(template_string_$item(_templateObject123 || (_templateObject123 = smolrunleg_taggedTemplateLiteral(["stick of firewood"]))))) {
          ...
          (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject124 || (_templateObject124 = smolrunleg_taggedTemplateLiteral(["campfire smoke"]))));
