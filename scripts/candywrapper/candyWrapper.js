...
function csrunleg_slicedToArray(arr, i) { return csrunleg_arrayWithHoles(arr) || csrunleg_iterableToArrayLimit(arr, i) || csrunleg_unsupportedIterableToArray(arr, i) || csrunleg_nonIterableRest(); }
function csrunleg_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function csrunleg_iterableToArrayLimit(arr, i) { var _i = null == arr ? null : "undefined" != typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"]; if (null != _i) { var _s, _e, _x, _r, _arr = [], _n = !0, _d = !1; try { if (_x = (_i = _i.call(arr)).next, 0 === i) { if (Object(_i) !== _i) return; _n = !1; } else for (; !(_n = (_s = _x.call(_i)).done) && (_arr.push(_s.value), _arr.length !== i); _n = !0); } catch (err) { _d = !0, _e = err; } finally { try { if (!_n && null != _i.return && (_r = _i.return(), Object(_r) !== _r)) return; } finally { if (_d) throw _e; } } return _arr; } }
function csrunleg_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
function csrunleg_createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = csrunleg_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e2) { throw _e2; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e3) { didErr = true; err = _e3; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }
function csrunleg_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return csrunleg_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return csrunleg_arrayLikeToArray(o, minLen); }
function csrunleg_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
...
function CSQuests() {
  return [{
    ...
    tasks: [{
      ...
      completed: () => !lib_have(template_string_$item(csrunleg_templateObject8 || (csrunleg_templateObject8 = csrunleg_taggedTemplateLiteral(["stick of firewood"])))) || smoke >= 10,
      do: () => {
      ...
      completed: () => lib_have(template_string_$effect(csrunleg_templateObject30 || (csrunleg_templateObject30 = csrunleg_taggedTemplateLiteral(["Eldritch Attunement"])))),
      do: () => {
        var source = new Map([[template_string_$item(csrunleg_templateObject31 || (csrunleg_templateObject31 = csrunleg_taggedTemplateLiteral(["eldritch elixir"]))), (0,external_kolmafia_namespaceObject.mallPrice)(template_string_$item(csrunleg_templateObject32 || (csrunleg_templateObject32 = csrunleg_taggedTemplateLiteral(["eldritch elixir"]))))], [template_string_$item(csrunleg_templateObject33 || (csrunleg_templateObject33 = csrunleg_taggedTemplateLiteral(["Eldritch snap"]))), (0,external_kolmafia_namespaceObject.mallPrice)(template_string_$item(csrunleg_templateObject34 || (csrunleg_templateObject34 = csrunleg_taggedTemplateLiteral(["Eldritch snap"]))))], [template_string_$item(csrunleg_templateObject35 || (csrunleg_templateObject35 = csrunleg_taggedTemplateLiteral(["eldritch mushroom pizza"]))), (0,external_kolmafia_namespaceObject.mallPrice)(template_string_$item(csrunleg_templateObject36 || (csrunleg_templateObject36 = csrunleg_taggedTemplateLiteral(["eldritch mushroom pizza"])))) - .5 * (0,external_kolmafia_namespaceObject.mallPrice)(template_string_$item(csrunleg_templateObject37 || (csrunleg_templateObject37 = csrunleg_taggedTemplateLiteral(["eldritch mushroom"]))))]]);
        var minPriceItem;
        var minPrice = 0;
        var _iterator = csrunleg_createForOfIteratorHelper(source),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var _step$value = csrunleg_slicedToArray(_step.value, 2),
              item = _step$value[0],
              price = _step$value[1];
            if (price < minPrice) {
              minPrice = price;
      ...
      prepare: () => uneffect(template_string_$effect(csrunleg_templateObject40 || (csrunleg_templateObject40 = csrunleg_taggedTemplateLiteral(["Beaten Up"])))),
      do: () => {
        if (lib_have(template_string_$familiar(csrunleg_templateObject41 || (csrunleg_templateObject41 = csrunleg_taggedTemplateLiteral(["Trick-or-Treating Tot"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("familiar Trick-or-Treating Tot");else if (lib_have(template_string_$familiar(csrunleg_templateObject42 || (csrunleg_templateObject42 = csrunleg_taggedTemplateLiteral(["Red-Nosed Snapper"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("familiar snapper");
        (0,external_kolmafia_namespaceObject.cliExecute)("freeCandy ".concat((0,external_kolmafia_namespaceObject.myAdventures)()));
      },
      post: () => {
        if ((0,external_kolmafia_namespaceObject.myAdventures)() === 0) $effects(csrunleg_templateObject43 || (csrunleg_templateObject43 = csrunleg_taggedTemplateLiteral(["Power Ballad of the Arrowsmith, Stevedave's Shanty of Superiority, The Moxious Madrigal, The Magical Mojomuscular Melody, Aloysius' Antiphon of Aptitude, Ur-Kel's Aria of Annoyance"]))).filter(ef => lib_have(ef)).forEach(ef => uneffect(ef));
      },
      clear: "all",
      tracking: "Garbo"
    }, {
      name: "Turn in FunFunds",
      ready: () => property_get("_stenchAirportToday") && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(csrunleg_templateObject44 || (csrunleg_templateObject44 = csrunleg_taggedTemplateLiteral(["FunFunds\u2122"])))) >= 20,
      completed: () => lib_have(template_string_$item(csrunleg_templateObject45 || (csrunleg_templateObject45 = csrunleg_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
      do: () => (0,external_kolmafia_namespaceObject.buy)($coinmaster(csrunleg_templateObject46 || (csrunleg_templateObject46 = csrunleg_taggedTemplateLiteral(["The Dinsey Company Store"]))), 1, template_string_$item(csrunleg_templateObject47 || (csrunleg_templateObject47 = csrunleg_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
      tracking: "Garbo"
    }, {
      name: "PvP",
      ...
      name: "Stooper",
      ready: () => (0,external_kolmafia_namespaceObject.myInebriety)() === (0,external_kolmafia_namespaceObject.inebrietyLimit)() && lib_have(template_string_$item(csrunleg_templateObject48 || (csrunleg_templateObject48 = csrunleg_taggedTemplateLiteral(["tiny stillsuit"])))) && property_get("familiarSweat") >= 300,
      completed: () => !lib_have(template_string_$familiar(csrunleg_templateObject49 || (csrunleg_templateObject49 = csrunleg_taggedTemplateLiteral(["Stooper"])))) || stooperDrunk(),
      do: () => {
        (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(csrunleg_templateObject50 || (csrunleg_templateObject50 = csrunleg_taggedTemplateLiteral(["Stooper"]))));
      ...
      name: "Do Pizza",
      ready: () => doneAdventuring(),
      completed: () => lib_have(template_string_$item(csrunleg_templateObject51 || (csrunleg_templateObject51 = csrunleg_taggedTemplateLiteral(["Pizza of Legend"])))) && lib_have(template_string_$item(csrunleg_templateObject52 || (csrunleg_templateObject52 = csrunleg_taggedTemplateLiteral(["Deep Dish of Legend"])))) && lib_have(template_string_$item(csrunleg_templateObject53 || (csrunleg_templateObject53 = csrunleg_taggedTemplateLiteral(["Calzone of Legend"])))),
      do: () => {
        ...
        !lib_have(template_string_$item(csrunleg_templateObject56 || (csrunleg_templateObject56 = csrunleg_taggedTemplateLiteral(["Deep Dish of Legend"])))) ? (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(csrunleg_templateObject57 || (csrunleg_templateObject57 = csrunleg_taggedTemplateLiteral(["Deep Dish of Legend"])))) : undefined;
        !lib_have(template_string_$item(csrunleg_templateObject58 || (csrunleg_templateObject58 = csrunleg_taggedTemplateLiteral(["Calzone of Legend"])))) ? (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(csrunleg_templateObject59 || (csrunleg_templateObject59 = csrunleg_taggedTemplateLiteral(["Calzone of Legend"])))) : undefined;
      }
    }, {
      name: "Plant Garden",
      ready: () => doneAdventuring() && !!template_string_$items(csrunleg_templateObject60 || (csrunleg_templateObject60 = csrunleg_taggedTemplateLiteral(["packet of rock seeds, packet of thanksgarden seeds, Peppermint Pip Packet, packet of winter seeds, packet of beer seeds, packet of pumpkin seeds, packet of dragon's teeth"]))).find(it => lib_have(it)),
      completed: () => getGarden() !== template_string_$item(csrunleg_templateObject61 || (csrunleg_templateObject61 = csrunleg_taggedTemplateLiteral(["packet of tall grass seeds"]))),
      do: () => {
        (0,external_kolmafia_namespaceObject.use)(template_string_$items(csrunleg_templateObject62 || (csrunleg_templateObject62 = csrunleg_taggedTemplateLiteral(["packet of rock seeds, packet of thanksgarden seeds, Peppermint Pip Packet, packet of winter seeds, packet of beer seeds, packet of pumpkin seeds, packet of dragon's teeth"]))).find(it => lib_have(it)) || template_string_$item(csrunleg_templateObject63 || (csrunleg_templateObject63 = csrunleg_taggedTemplateLiteral(["none"]))));
      ...
      prepare: () => uneffect(template_string_$effect(csrunleg_templateObject64 || (csrunleg_templateObject64 = csrunleg_taggedTemplateLiteral(["Beaten Up"])))),
      do: () => {
        (0,external_kolmafia_namespaceObject.cliExecute)("freeCandy ".concat((0,external_kolmafia_namespaceObject.myAdventures)()));
      },
      post: () => {
        if ((0,external_kolmafia_namespaceObject.myAdventures)() === 0) $effects(csrunleg_templateObject65 || (csrunleg_templateObject65 = csrunleg_taggedTemplateLiteral(["Power Ballad of the Arrowsmith, Stevedave's Shanty of Superiority, The Moxious Madrigal, The Magical Mojomuscular Melody, Aloysius' Antiphon of Aptitude, Ur-Kel's Aria of Annoyance"]))).filter(ef => lib_have(ef)).forEach(ef => uneffect(ef));
      },
      clear: "all",
      tracking: "Garbo",
      limit: {
      ...
      ready: () => lib_have(template_string_$item(csrunleg_templateObject66 || (csrunleg_templateObject66 = csrunleg_taggedTemplateLiteral(["august scepter"])))),
      completed: () => lib_have(template_string_$effect(csrunleg_templateObject67 || (csrunleg_templateObject67 = csrunleg_taggedTemplateLiteral(["Offhand Remarkable"])))) || property_get("_aug13Cast", false) || property_get("_augSkillsCast", 0) >= 5 && gameDay().getDate() !== 13,
      do: () => (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(csrunleg_templateObject68 || (csrunleg_templateObject68 = csrunleg_taggedTemplateLiteral(["Aug. 13th: Left/Off Hander's Day!"]))))
    }, {
      name: "Alternative Offhand Remarkable",
      ready: () => offhandWorth,
      completed: () => lib_have(template_string_$effect(csrunleg_templateObject69 || (csrunleg_templateObject69 = csrunleg_taggedTemplateLiteral(["Offhand Remarkable"])))),
      do: () => {
        (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(csrunleg_templateObject70 || (csrunleg_templateObject70 = csrunleg_taggedTemplateLiteral(["pocket wish"]))));
      ...
      name: "Pajamas",
      completed: () => lib_have(template_string_$item(csrunleg_templateObject71 || (csrunleg_templateObject71 = csrunleg_taggedTemplateLiteral(["burning cape"])))),
      acquire: [{
        item: template_string_$item(csrunleg_templateObject72 || (csrunleg_templateObject72 = csrunleg_taggedTemplateLiteral(["clockwork maid"]))),
        price: 7 * property_get("valueOfAdventure"),
        optional: true
      }, {
        item: template_string_$item(csrunleg_templateObject73 || (csrunleg_templateObject73 = csrunleg_taggedTemplateLiteral(["burning cape"])))
      }],
      do: () => {
        if (lib_have(template_string_$item(csrunleg_templateObject74 || (csrunleg_templateObject74 = csrunleg_taggedTemplateLiteral(["clockwork maid"]))))) {
          (0,external_kolmafia_namespaceObject.use)(template_string_$item(csrunleg_templateObject75 || (csrunleg_templateObject75 = csrunleg_taggedTemplateLiteral(["clockwork maid"]))));
        }
...
function AftercoreQuest() {
  return {
    ...
    tasks: [{
      ...
      name: "Prep Fireworks Shop",
      completed: () => !lib_have(template_string_$item(aftercoreleg_templateObject || (aftercoreleg_templateObject = aftercoreleg_taggedTemplateLiteral(["Clan VIP Lounge key"])))) || property_get("_goorboFireworksPrepped", false),
      do: () => {
        (0,external_kolmafia_namespaceObject.visitUrl)("clan_viplounge.php?action=fwshop&whichfloor=2");
        _set("_goorboFireworksPrepped", true);
      }
      ...
      name: "Harvest Garden",
      completed: () => getGarden() === template_string_$item(aftercoreleg_templateObject2 || (aftercoreleg_templateObject2 = aftercoreleg_taggedTemplateLiteral(["none"]))) || getGarden() === template_string_$item(aftercoreleg_templateObject3 || (aftercoreleg_templateObject3 = aftercoreleg_taggedTemplateLiteral(["packet of mushroom spores"]))) || (0,external_kolmafia_namespaceObject.getCampground)()[getGarden().name] === 0,
      ...
      name: "Plant Grass",
      completed: () => !lib_have(template_string_$item(aftercoreleg_templateObject4 || (aftercoreleg_templateObject4 = aftercoreleg_taggedTemplateLiteral(["packet of tall grass seeds"])))) || getGarden() === template_string_$item(aftercoreleg_templateObject5 || (aftercoreleg_templateObject5 = aftercoreleg_taggedTemplateLiteral(["packet of tall grass seeds"]))),
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(aftercoreleg_templateObject6 || (aftercoreleg_templateObject6 = aftercoreleg_taggedTemplateLiteral(["packet of tall grass seeds"]))))
    }, {
      name: "SIT Course",
      // eslint-disable-next-line libram/verify-constants
      ready: () => lib_have(template_string_$item(aftercoreleg_templateObject7 || (aftercoreleg_templateObject7 = aftercoreleg_taggedTemplateLiteral(["S.I.T. Course Completion Certificate"])))),
      ...
      do: () =>
      // eslint-disable-next-line libram/verify-constants
      (0,external_kolmafia_namespaceObject.use)(template_string_$item(aftercoreleg_templateObject8 || (aftercoreleg_templateObject8 = aftercoreleg_taggedTemplateLiteral(["S.I.T. Course Completion Certificate"]))))
    }, {
      name: "Drive Observantly",
      completed: () => property_get("dailyDungeonDone") || (0,external_kolmafia_namespaceObject.getWorkshed)() !== template_string_$item(aftercoreleg_templateObject9 || (aftercoreleg_templateObject9 = aftercoreleg_taggedTemplateLiteral(["Asdon Martin keyfob (on ring)"]))) || (0,external_kolmafia_namespaceObject.haveEffect)(template_string_$effect(aftercoreleg_templateObject10 || (aftercoreleg_templateObject10 = aftercoreleg_taggedTemplateLiteral(["Driving Observantly"])))) >= (totallyDrunk() || !lib_have(template_string_$item(aftercoreleg_templateObject11 || (aftercoreleg_templateObject11 = aftercoreleg_taggedTemplateLiteral(["Drunkula's wineglass"])))) ? (0,external_kolmafia_namespaceObject.myAdventures)() : (0,external_kolmafia_namespaceObject.myAdventures)() + 60),
      do: () => drive(template_string_$effect(aftercoreleg_templateObject12 || (aftercoreleg_templateObject12 = aftercoreleg_taggedTemplateLiteral(["Driving Observantly"]))), totallyDrunk() || !lib_have(template_string_$item(aftercoreleg_templateObject13 || (aftercoreleg_templateObject13 = aftercoreleg_taggedTemplateLiteral(["Drunkula's wineglass"])))) ? (0,external_kolmafia_namespaceObject.myAdventures)() : (0,external_kolmafia_namespaceObject.myAdventures)() + 60, false),
      limit: {
        tries: 5
      }
    }, {
      name: "Sample Constellation DNA",
      ready: () => lib_have(template_string_$item(aftercoreleg_templateObject14 || (aftercoreleg_templateObject14 = aftercoreleg_taggedTemplateLiteral(["DNA extraction syringe"])))),
      completed: () => !DNALab_installed() || isHybridized($phylum(aftercoreleg_templateObject15 || (aftercoreleg_templateObject15 = aftercoreleg_taggedTemplateLiteral(["Constellation"])))) || property_get("dnaSyringe") === $phylum(aftercoreleg_templateObject16 || (aftercoreleg_templateObject16 = aftercoreleg_taggedTemplateLiteral(["Constellation"]))),
      outfit: {
        familiar: bestFam(),
        modifier: "".concat(maxBase())
      },
      do: $location(aftercoreleg_templateObject17 || (aftercoreleg_templateObject17 = aftercoreleg_taggedTemplateLiteral(["The Hole in the Sky"]))),
      combat: new CombatStrategy().macro(Macro.skill(template_string_$skill(aftercoreleg_templateObject18 || (aftercoreleg_templateObject18 = aftercoreleg_taggedTemplateLiteral(["Curse of Weaksauce"])))), getTodaysHolidayWanderers()).macro(Macro.tryItem(template_string_$item(aftercoreleg_templateObject19 || (aftercoreleg_templateObject19 = aftercoreleg_taggedTemplateLiteral(["DNA extraction syringe"]))))).macro(Macro.tryItem(template_string_$item(aftercoreleg_templateObject20 || (aftercoreleg_templateObject20 = aftercoreleg_taggedTemplateLiteral(["train whistle"])))).tryItem(template_string_$item(aftercoreleg_templateObject21 || (aftercoreleg_templateObject21 = aftercoreleg_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill(template_string_$skill(aftercoreleg_templateObject22 || (aftercoreleg_templateObject22 = aftercoreleg_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
    }, {
      name: "Hybridize Constellation",
      ready: () => property_get("dnaSyringe") === $phylum(aftercoreleg_templateObject23 || (aftercoreleg_templateObject23 = aftercoreleg_taggedTemplateLiteral(["Constellation"]))),
      completed: () => !DNALab_installed() || isHybridized($phylum(aftercoreleg_templateObject24 || (aftercoreleg_templateObject24 = aftercoreleg_taggedTemplateLiteral(["Constellation"])))),
      do: () => {
        makeTonic(3);
        hybridize();
      }
      ...
      isGoodGarboScript(args.garboascend) || args.pulls.includes(template_string_$item(aftercoreleg_templateObject25 || (aftercoreleg_templateObject25 = aftercoreleg_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
      completed: () => !lib_have(template_string_$item(aftercoreleg_templateObject26 || (aftercoreleg_templateObject26 = aftercoreleg_taggedTemplateLiteral(["lucky gold ring"])))) || property_get("_stenchAirportToday") || property_get("stenchAirportAlways"),
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(aftercoreleg_templateObject27 || (aftercoreleg_templateObject27 = aftercoreleg_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"]))))
    }, {
      name: "June Cleaver",
      completed: () => !lib_have(template_string_$item(aftercoreleg_templateObject28 || (aftercoreleg_templateObject28 = aftercoreleg_taggedTemplateLiteral(["June cleaver"])))) || property_get("_juneCleaverFightsLeft") > 0 || (0,external_kolmafia_namespaceObject.myAdventures)() === 0,
      choices: {
        1467: 3,
        //Poetic Justice
      ...
      do: $location(aftercoreleg_templateObject29 || (aftercoreleg_templateObject29 = aftercoreleg_taggedTemplateLiteral(["Noob Cave"]))),
      post: () => {
        if ((0,external_kolmafia_namespaceObject.handlingChoice)()) (0,external_kolmafia_namespaceObject.visitUrl)("main.php");
        if (lib_have(template_string_$effect(aftercoreleg_templateObject30 || (aftercoreleg_templateObject30 = aftercoreleg_taggedTemplateLiteral(["Beaten Up"]))))) uneffect(template_string_$effect(aftercoreleg_templateObject31 || (aftercoreleg_templateObject31 = aftercoreleg_taggedTemplateLiteral(["Beaten Up"]))));
      },
      outfit: () => ({
        equip: template_string_$items(aftercoreleg_templateObject32 || (aftercoreleg_templateObject32 = aftercoreleg_taggedTemplateLiteral(["June cleaver"])))
      }),
      limit: undefined
    }, {
      name: "Restore HP",
      ...
      ready: () => lib_have(template_string_$item(aftercoreleg_templateObject33 || (aftercoreleg_templateObject33 = aftercoreleg_taggedTemplateLiteral(["[glitch season reward name]"])))),
      completed: () => property_get("_glitchItemImplemented"),
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(aftercoreleg_templateObject34 || (aftercoreleg_templateObject34 = aftercoreleg_taggedTemplateLiteral(["[glitch season reward name]"]))))
    }, {
      name: "Fight Glitch",
      ready: () => lib_have(template_string_$item(aftercoreleg_templateObject35 || (aftercoreleg_templateObject35 = aftercoreleg_taggedTemplateLiteral(["[glitch season reward name]"])))),
      completed: () => property_get("_glitchMonsterFights") > 0,
      acquire: template_string_$items(aftercoreleg_templateObject36 || (aftercoreleg_templateObject36 = aftercoreleg_taggedTemplateLiteral(["gas can, gas balloon, shard of double-ice"]))).map(it => ({
        item: it,
        price: 1000
      })),
      prepare: () => {
        (0,external_kolmafia_namespaceObject.restoreHp)(0.9 * (0,external_kolmafia_namespaceObject.myMaxhp)());
        if (lib_have(template_string_$skill(aftercoreleg_templateObject37 || (aftercoreleg_templateObject37 = aftercoreleg_taggedTemplateLiteral(["Blood Bubble"])))) && !lib_have(template_string_$effect(aftercoreleg_templateObject38 || (aftercoreleg_templateObject38 = aftercoreleg_taggedTemplateLiteral(["Blood Bubble"]))))) (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(aftercoreleg_templateObject39 || (aftercoreleg_templateObject39 = aftercoreleg_taggedTemplateLiteral(["Blood Bubble"]))));
      },
      ...
      combat: new CombatStrategy().macro(() => {
        ...
        return (_Macro$tryItem$trySki = Macro.tryItem(template_string_$item(aftercoreleg_templateObject40 || (aftercoreleg_templateObject40 = aftercoreleg_taggedTemplateLiteral(["gas balloon"])))).trySkill(template_string_$skill(aftercoreleg_templateObject41 || (aftercoreleg_templateObject41 = aftercoreleg_taggedTemplateLiteral(["Feel Pride"]))))).tryItem.apply(_Macro$tryItem$trySki, aftercoreleg_toConsumableArray(template_string_$items(aftercoreleg_templateObject42 || (aftercoreleg_templateObject42 = aftercoreleg_taggedTemplateLiteral(["shard of double-ice, gas can"]))))).attack().repeat();
      }),
      tracking: "Leveling"
    }, {
      name: "Unlock Guild",
      ...
      name: "Marble Soda!",
      ready: () => doCS,
      completed: () => lib_have(template_string_$item(_templateObject98 || (_templateObject98 = aftercoreleg_taggedTemplateLiteral(["tobiko marble soda"])))) || (0,external_kolmafia_namespaceObject.mallPrice)(template_string_$item(_templateObject99 || (_templateObject99 = aftercoreleg_taggedTemplateLiteral(["tobiko marble soda"])))) > property_get("valueOfAdventure") * 2,
      do: () => {
        (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(_templateObject100 || (_templateObject100 = aftercoreleg_taggedTemplateLiteral(["tobiko marble soda"]))));
      }
    }, {
      name: "Prepare for LoopCS",
      ready: () => doCS,
      completed: () => lib_have(template_string_$item(_templateObject101 || (_templateObject101 = aftercoreleg_taggedTemplateLiteral(["Pizza of Legend"])))) && lib_have(template_string_$item(_templateObject102 || (_templateObject102 = aftercoreleg_taggedTemplateLiteral(["Deep Dish of Legend"])))) && lib_have(template_string_$item(_templateObject103 || (_templateObject103 = aftercoreleg_taggedTemplateLiteral(["Calzone of Legend"])))),
      do: () => {
        !lib_have(template_string_$item(_templateObject104 || (_templateObject104 = aftercoreleg_taggedTemplateLiteral(["Pizza of Legend"])))) ? (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(_templateObject105 || (_templateObject105 = aftercoreleg_taggedTemplateLiteral(["Pizza of Legend"])))) : undefined;
        !lib_have(template_string_$item(_templateObject106 || (_templateObject106 = aftercoreleg_taggedTemplateLiteral(["Deep Dish of Legend"])))) ? (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(_templateObject107 || (_templateObject107 = aftercoreleg_taggedTemplateLiteral(["Deep Dish of Legend"])))) : undefined;
        !lib_have(template_string_$item(_templateObject108 || (_templateObject108 = aftercoreleg_taggedTemplateLiteral(["Calzone of Legend"])))) ? (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(_templateObject109 || (_templateObject109 = aftercoreleg_taggedTemplateLiteral(["Calzone of Legend"])))) : undefined;
        !lib_have(template_string_$item(_templateObject110 || (_templateObject110 = aftercoreleg_taggedTemplateLiteral(["borrowed time"])))) ? (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(_templateObject111 || (_templateObject111 = aftercoreleg_taggedTemplateLiteral(["borrowed time"])))) : undefined;
      }
    }, {
...
function altWorkshed() {
  ...
  switch (ws) {
    case template_string_$item(smolrunleg_templateObject8 || (smolrunleg_templateObject8 = smolrunleg_taggedTemplateLiteral(["model train set"]))):
      return template_string_$items(smolrunleg_templateObject9 || (smolrunleg_templateObject9 = smolrunleg_taggedTemplateLiteral(["cold medicine cabinet, Asdon Martin keyfob, Little Geneticist DNA-Splicing Lab, portable Mayo Clinic"]))).find(it => lib_have(it) || (0,external_kolmafia_namespaceObject.getWorkshed)() === it || (0,external_kolmafia_namespaceObject.storageAmount)(it) > 0) || ws;
    case template_string_$item(smolrunleg_templateObject10 || (smolrunleg_templateObject10 = smolrunleg_taggedTemplateLiteral(["Asdon Martin keyfob"]))):
    ...
    case template_string_$item(smolrunleg_templateObject14 || (smolrunleg_templateObject14 = smolrunleg_taggedTemplateLiteral(["Little Geneticist DNA-Splicing Lab"]))):
      return template_string_$items(smolrunleg_templateObject15 || (smolrunleg_templateObject15 = smolrunleg_taggedTemplateLiteral(["cold medicine cabinet, Asdon Martin keyfob, model train set, portable Mayo Clinic"]))).find(it => lib_have(it) || (0,external_kolmafia_namespaceObject.getWorkshed)() === it || (0,external_kolmafia_namespaceObject.storageAmount)(it) > 0) || ws;
    case template_string_$item(smolrunleg_templateObject16 || (smolrunleg_templateObject16 = smolrunleg_taggedTemplateLiteral(["portable Mayo Clinic"]))):
      return template_string_$items(smolrunleg_templateObject17 || (smolrunleg_templateObject17 = smolrunleg_taggedTemplateLiteral(["cold medicine cabinet, model train set, Asdon Martin keyfob, Little Geneticist DNA-Splicing Lab"]))).find(it => lib_have(it) || (0,external_kolmafia_namespaceObject.getWorkshed)() === it || (0,external_kolmafia_namespaceObject.storageAmount)(it) > 0) || ws;
    default:
...
function SmolQuests() {
  return [{
    ...
    tasks: [{
      ...
      name: "Drink Pre-Tune",
      ready: () => (0,external_kolmafia_namespaceObject.mySign)().toLowerCase() === "blender" && (0,external_kolmafia_namespaceObject.myLevel)() >= 7 && lib_have(template_string_$item(smolrunleg_templateObject46 || (smolrunleg_templateObject46 = smolrunleg_taggedTemplateLiteral(["mime army shotglass"])))) && (lib_have(template_string_$item(smolrunleg_templateObject47 || (smolrunleg_templateObject47 = smolrunleg_taggedTemplateLiteral(["astral pilsner"])))) || lib_have(template_string_$item(smolrunleg_templateObject48 || (smolrunleg_templateObject48 = smolrunleg_taggedTemplateLiteral(["astral six-pack"]))))),
      completed: () => property_get("_mimeArmyShotglassUsed") || !lib_have(template_string_$item(smolrunleg_templateObject49 || (smolrunleg_templateObject49 = smolrunleg_taggedTemplateLiteral(["hewn moon-rune spoon"])))) || property_get("moonTuned"),
      prepare: () => {
        if (lib_have(template_string_$item(smolrunleg_templateObject50 || (smolrunleg_templateObject50 = smolrunleg_taggedTemplateLiteral(["astral six-pack"]))))) (0,external_kolmafia_namespaceObject.use)(template_string_$item(smolrunleg_templateObject51 || (smolrunleg_templateObject51 = smolrunleg_taggedTemplateLiteral(["astral six-pack"]))));
      },
      do: () => (0,external_kolmafia_namespaceObject.drink)(1, template_string_$item(smolrunleg_templateObject52 || (smolrunleg_templateObject52 = smolrunleg_taggedTemplateLiteral(["astral pilsner"]))))
    }, {
      name: "Moon Spoon",
      completed: () => !lib_have(template_string_$item(smolrunleg_templateObject53 || (smolrunleg_templateObject53 = smolrunleg_taggedTemplateLiteral(["hewn moon-rune spoon"])))) || property_get("moonTuned") || (0,external_kolmafia_namespaceObject.mySign)().toLowerCase() === "wombat",
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("spoon wombat")
    }, {
      name: "Install Alternate Workshed",
      ready: () => lib_have(altWorkshed()),
      completed: () => altWorkshed() === template_string_$item(smolrunleg_templateObject54 || (smolrunleg_templateObject54 = smolrunleg_taggedTemplateLiteral(["none"]))) || property_get("_workshedItemUsed") || (0,external_kolmafia_namespaceObject.getWorkshed)() === altWorkshed(),
      do: () => (0,external_kolmafia_namespaceObject.use)(altWorkshed())
    }, {
      name: "Gold Wedding Ring",
      completed: () => !lib_have(template_string_$skill(smolrunleg_templateObject55 || (smolrunleg_templateObject55 = smolrunleg_taggedTemplateLiteral(["Comprehensive Cartography"])))) || (0,external_kolmafia_namespaceObject.myAscensions)() === property_get("lastCartographyBooPeak"),
      choices: {
        1430: 3,
        606: 4,
        610: 1,
      ...
      do: $location(smolrunleg_templateObject56 || (smolrunleg_templateObject56 = smolrunleg_taggedTemplateLiteral(["A-Boo Peak"]))),
      outfit: {
      ...
      name: "Laugh Floor",
      completed: () => lib_have(template_string_$skill(smolrunleg_templateObject57 || (smolrunleg_templateObject57 = smolrunleg_taggedTemplateLiteral(["Liver of Steel"])))) || lib_have(template_string_$item(smolrunleg_templateObject58 || (smolrunleg_templateObject58 = smolrunleg_taggedTemplateLiteral(["steel margarita"])))) || lib_have(template_string_$item(smolrunleg_templateObject59 || (smolrunleg_templateObject59 = smolrunleg_taggedTemplateLiteral(["Azazel's lollipop"])))) || lib_have(template_string_$item(smolrunleg_templateObject60 || (smolrunleg_templateObject60 = smolrunleg_taggedTemplateLiteral(["observational glasses"])))),
      effects: () => [].concat(smolrunleg_toConsumableArray(lib_have(template_string_$skill(smolrunleg_templateObject61 || (smolrunleg_templateObject61 = smolrunleg_taggedTemplateLiteral(["Musk of the Moose"])))) ? $effects(smolrunleg_templateObject62 || (smolrunleg_templateObject62 = smolrunleg_taggedTemplateLiteral(["Musk of the Moose"]))) : []), smolrunleg_toConsumableArray(lib_have(template_string_$skill(smolrunleg_templateObject63 || (smolrunleg_templateObject63 = smolrunleg_taggedTemplateLiteral(["Carlweather's Cantata of Confrontation"])))) ? $effects(smolrunleg_templateObject64 || (smolrunleg_templateObject64 = smolrunleg_taggedTemplateLiteral(["Carlweather's Cantata of Confrontation"]))) : [])),
      prepare: () => {
        if (!lib_have(template_string_$effect(smolrunleg_templateObject65 || (smolrunleg_templateObject65 = smolrunleg_taggedTemplateLiteral(["Carlweather's Cantata of Confrontation"]))))) {
        ...
        $effects(smolrunleg_templateObject66 || (smolrunleg_templateObject66 = smolrunleg_taggedTemplateLiteral(["Smooth Movements, The Sonata of Sneakiness, Darkened Photons, Shifted Phase"]))).forEach(ef => (0,external_kolmafia_namespaceObject.cliExecute)("uneffect ".concat(ef)));
        (0,external_kolmafia_namespaceObject.restoreHp)(0.75 * (0,external_kolmafia_namespaceObject.myMaxhp)());
        (0,external_kolmafia_namespaceObject.restoreMp)(20);
      },
      do: $location(smolrunleg_templateObject67 || (smolrunleg_templateObject67 = smolrunleg_taggedTemplateLiteral(["The Laugh Floor"]))),
      outfit: () => ({
        familiar: bestFam(),
        modifier: "".concat(maxBase(), ", 100 combat rate, 3 item, 250 bonus carnivorous potted plant")
      }),
      combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(smolrunleg_templateObject68 || (smolrunleg_templateObject68 = smolrunleg_taggedTemplateLiteral(["Curse of Weaksauce"])))).tryItem(template_string_$item(smolrunleg_templateObject69 || (smolrunleg_templateObject69 = smolrunleg_taggedTemplateLiteral(["train whistle"])))).tryItem(template_string_$item(smolrunleg_templateObject70 || (smolrunleg_templateObject70 = smolrunleg_taggedTemplateLiteral(["porquoise-handled sixgun"])))).attack().repeat()),
      limit: {
        tries: 15
      }
    }, {
      name: "Infernal Rackets Backstage",
      completed: () => lib_have(template_string_$skill(smolrunleg_templateObject71 || (smolrunleg_templateObject71 = smolrunleg_taggedTemplateLiteral(["Liver of Steel"])))) || lib_have(template_string_$item(smolrunleg_templateObject72 || (smolrunleg_templateObject72 = smolrunleg_taggedTemplateLiteral(["steel margarita"])))) || lib_have(template_string_$item(smolrunleg_templateObject73 || (smolrunleg_templateObject73 = smolrunleg_taggedTemplateLiteral(["Azazel's unicorn"])))) || backstageItemsDone(),
      effects: () => [].concat(smolrunleg_toConsumableArray(lib_have(template_string_$skill(smolrunleg_templateObject74 || (smolrunleg_templateObject74 = smolrunleg_taggedTemplateLiteral(["Smooth Movement"])))) ? $effects(smolrunleg_templateObject75 || (smolrunleg_templateObject75 = smolrunleg_taggedTemplateLiteral(["Smooth Movements"]))) : []), smolrunleg_toConsumableArray(lib_have(template_string_$skill(smolrunleg_templateObject76 || (smolrunleg_templateObject76 = smolrunleg_taggedTemplateLiteral(["The Sonata of Sneakiness"])))) ? $effects(smolrunleg_templateObject77 || (smolrunleg_templateObject77 = smolrunleg_taggedTemplateLiteral(["The Sonata of Sneakiness"]))) : [])),
      prepare: () => {
        if (!lib_have(template_string_$effect(smolrunleg_templateObject78 || (smolrunleg_templateObject78 = smolrunleg_taggedTemplateLiteral(["The Sonata of Sneakiness"]))))) {
          (0,external_kolmafia_namespaceObject.cliExecute)("kmail to Buffy || 10 Sonata of Sneakiness");
          (0,external_kolmafia_namespaceObject.wait)(15);
          (0,external_kolmafia_namespaceObject.cliExecute)("refresh effects");
        }
        $effects(smolrunleg_templateObject79 || (smolrunleg_templateObject79 = smolrunleg_taggedTemplateLiteral(["Musk of the Moose, Carlweather's Cantata of Confrontation, Hooooooooonk!"]))).forEach(ef => (0,external_kolmafia_namespaceObject.cliExecute)("uneffect ".concat(ef)));
        (0,external_kolmafia_namespaceObject.restoreHp)(0.75 * (0,external_kolmafia_namespaceObject.myMaxhp)());
        (0,external_kolmafia_namespaceObject.restoreMp)(20);
      },
      do: $location(smolrunleg_templateObject80 || (smolrunleg_templateObject80 = smolrunleg_taggedTemplateLiteral(["Infernal Rackets Backstage"]))),
      outfit: () => ({
        familiar: bestFam(),
        modifier: "".concat(maxBase(), ", -100 combat rate, 3 item, 250 bonus carnivorous potted plant")
      }),
      combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(smolrunleg_templateObject81 || (smolrunleg_templateObject81 = smolrunleg_taggedTemplateLiteral(["Curse of Weaksauce"])))).tryItem(template_string_$item(smolrunleg_templateObject82 || (smolrunleg_templateObject82 = smolrunleg_taggedTemplateLiteral(["train whistle"])))).tryItem(template_string_$item(smolrunleg_templateObject83 || (smolrunleg_templateObject83 = smolrunleg_taggedTemplateLiteral(["porquoise-handled sixgun"])))).attack().repeat()),
      limit: {
        tries: 15
      }
    }, {
      name: "Mourn",
      ready: () => lib_have(template_string_$item(smolrunleg_templateObject84 || (smolrunleg_templateObject84 = smolrunleg_taggedTemplateLiteral(["observational glasses"])))),
      completed: () => lib_have(template_string_$skill(smolrunleg_templateObject85 || (smolrunleg_templateObject85 = smolrunleg_taggedTemplateLiteral(["Liver of Steel"])))) || lib_have(template_string_$item(smolrunleg_templateObject86 || (smolrunleg_templateObject86 = smolrunleg_taggedTemplateLiteral(["steel margarita"])))) || lib_have(template_string_$item(smolrunleg_templateObject87 || (smolrunleg_templateObject87 = smolrunleg_taggedTemplateLiteral(["Azazel's lollipop"])))),
      outfit: {
        equip: template_string_$items(smolrunleg_templateObject88 || (smolrunleg_templateObject88 = smolrunleg_taggedTemplateLiteral(["hilarious comedy prop, observational glasses, Victor, the Insult Comic Hellhound Puppet"], ["hilarious comedy prop, observational glasses, Victor\\, the Insult Comic Hellhound Puppet"])))
      },
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("panda comedy insult; panda comedy observe")
    }, {
      name: "Sven Golly",
      ready: () => backstageItemsDone(),
      completed: () => lib_have(template_string_$skill(smolrunleg_templateObject89 || (smolrunleg_templateObject89 = smolrunleg_taggedTemplateLiteral(["Liver of Steel"])))) || lib_have(template_string_$item(smolrunleg_templateObject90 || (smolrunleg_templateObject90 = smolrunleg_taggedTemplateLiteral(["steel margarita"])))) || lib_have(template_string_$item(smolrunleg_templateObject91 || (smolrunleg_templateObject91 = smolrunleg_taggedTemplateLiteral(["Azazel's unicorn"])))),
      do: () => {
        (0,external_kolmafia_namespaceObject.cliExecute)("panda arena Bognort ".concat(template_string_$items(smolrunleg_templateObject92 || (smolrunleg_templateObject92 = smolrunleg_taggedTemplateLiteral(["giant marshmallow, gin-soaked blotter paper"]))).find(a => lib_have(a))));
        (0,external_kolmafia_namespaceObject.cliExecute)("panda arena Stinkface ".concat(template_string_$items(smolrunleg_templateObject93 || (smolrunleg_templateObject93 = smolrunleg_taggedTemplateLiteral(["beer-scented teddy bear, gin-soaked blotter paper"]))).find(a => lib_have(a))));
        (0,external_kolmafia_namespaceObject.cliExecute)("panda arena Flargwurm ".concat(template_string_$items(smolrunleg_templateObject94 || (smolrunleg_templateObject94 = smolrunleg_taggedTemplateLiteral(["booze-soaked cherry, sponge cake"]))).find(a => lib_have(a))));
        (0,external_kolmafia_namespaceObject.cliExecute)("panda arena Jim ".concat(template_string_$items(smolrunleg_templateObject95 || (smolrunleg_templateObject95 = smolrunleg_taggedTemplateLiteral(["comfy pillow, sponge cake"]))).find(a => lib_have(a))));
      }
    }, {
      name: "Moaning Panda",
      ready: () => haveAll(template_string_$items(smolrunleg_templateObject96 || (smolrunleg_templateObject96 = smolrunleg_taggedTemplateLiteral(["Azazel's lollipop, Azazel's unicorn"])))),
      completed: () => lib_have(template_string_$skill(smolrunleg_templateObject97 || (smolrunleg_templateObject97 = smolrunleg_taggedTemplateLiteral(["Liver of Steel"])))) || lib_have(template_string_$item(smolrunleg_templateObject98 || (smolrunleg_templateObject98 = smolrunleg_taggedTemplateLiteral(["steel margarita"])))) || lib_have(template_string_$item(smolrunleg_templateObject99 || (smolrunleg_templateObject99 = smolrunleg_taggedTemplateLiteral(["Azazel's tutu"])))),
      acquire: () => template_string_$items(smolrunleg_templateObject100 || (smolrunleg_templateObject100 = smolrunleg_taggedTemplateLiteral(["bus pass, imp air"]))).map(it => ({
        item: it,
        num: 5,
      ...
      ready: () => haveAll(template_string_$items(smolrunleg_templateObject101 || (smolrunleg_templateObject101 = smolrunleg_taggedTemplateLiteral(["Azazel's tutu, Azazel's lollipop, Azazel's unicorn"])))),
      completed: () => lib_have(template_string_$skill(smolrunleg_templateObject102 || (smolrunleg_templateObject102 = smolrunleg_taggedTemplateLiteral(["Liver of Steel"])))) || lib_have(template_string_$item(smolrunleg_templateObject103 || (smolrunleg_templateObject103 = smolrunleg_taggedTemplateLiteral(["steel margarita"])))),
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("panda temple")
    }, {
      name: "Liver of Steel",
      ready: () => lib_have(template_string_$item(smolrunleg_templateObject104 || (smolrunleg_templateObject104 = smolrunleg_taggedTemplateLiteral(["steel margarita"])))),
      completed: () => lib_have(template_string_$skill(smolrunleg_templateObject105 || (smolrunleg_templateObject105 = smolrunleg_taggedTemplateLiteral(["Liver of Steel"])))),
      do: () => (0,external_kolmafia_namespaceObject.drink)(1, template_string_$item(smolrunleg_templateObject106 || (smolrunleg_templateObject106 = smolrunleg_taggedTemplateLiteral(["steel margarita"]))))
    }, {
      name: "Garbo",
      ready: () => property_get("_stenchAirportToday") || property_get("stenchAirportAlways"),
      completed: () => (0,external_kolmafia_namespaceObject.myAdventures)() === 0 && !canDiet() || stooperDrunk(),
      prepare: () => uneffect(template_string_$effect(smolrunleg_templateObject107 || (smolrunleg_templateObject107 = smolrunleg_taggedTemplateLiteral(["Beaten Up"])))),
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)(args.garbo),
      post: () => $effects(smolrunleg_templateObject108 || (smolrunleg_templateObject108 = smolrunleg_taggedTemplateLiteral(["Power Ballad of the Arrowsmith, Stevedave's Shanty of Superiority, The Moxious Madrigal, The Magical Mojomuscular Melody, Aloysius' Antiphon of Aptitude, Ur-Kel's Aria of Annoyance"]))).filter(ef => lib_have(ef)).forEach(ef => uneffect(ef)),
      clear: "all",
      tracking: "Garbo"
    }, {
      name: "Turn in FunFunds",
      ready: () => property_get("_stenchAirportToday") && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(smolrunleg_templateObject109 || (smolrunleg_templateObject109 = smolrunleg_taggedTemplateLiteral(["FunFunds\u2122"])))) >= 20,
      completed: () => lib_have(template_string_$item(smolrunleg_templateObject110 || (smolrunleg_templateObject110 = smolrunleg_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
      do: () => (0,external_kolmafia_namespaceObject.buy)($coinmaster(smolrunleg_templateObject111 || (smolrunleg_templateObject111 = smolrunleg_taggedTemplateLiteral(["The Dinsey Company Store"]))), 1, template_string_$item(_templateObject112 || (_templateObject112 = smolrunleg_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
      tracking: "Garbo"
    }, {
      name: "PvP",
      ready: () => doneAdventuring(),
      ...
      name: "Stooper",
      ready: () => (0,external_kolmafia_namespaceObject.myInebriety)() === (0,external_kolmafia_namespaceObject.inebrietyLimit)() && lib_have(template_string_$item(_templateObject113 || (_templateObject113 = smolrunleg_taggedTemplateLiteral(["tiny stillsuit"])))) && property_get("familiarSweat") >= 300,
      completed: () => !lib_have(template_string_$familiar(_templateObject114 || (_templateObject114 = smolrunleg_taggedTemplateLiteral(["Stooper"])))) || stooperDrunk(),
      do: () => {
        (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject115 || (_templateObject115 = smolrunleg_taggedTemplateLiteral(["Stooper"]))));
        (0,external_kolmafia_namespaceObject.cliExecute)("drink stillsuit distillate");
      }
    }, {
      name: "Nightcap",
      ...
      name: "Smoke em if you got em",
      completed: () => !lib_have(template_string_$item(_templateObject116 || (_templateObject116 = smolrunleg_taggedTemplateLiteral(["stick of firewood"])))),
      do: () => {
        while (lib_have(template_string_$item(_templateObject117 || (_templateObject117 = smolrunleg_taggedTemplateLiteral(["stick of firewood"]))))) {
          ...
          (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject118 || (_templateObject118 = smolrunleg_taggedTemplateLiteral(["campfire smoke"]))));
      ...
      name: "Offhand Remarkable",
      // eslint-disable-next-line libram/verify-constants
      ready: () => lib_have(template_string_$item(_templateObject119 || (_templateObject119 = smolrunleg_taggedTemplateLiteral(["August Scepter"])))),
      completed: () => !lib_have(template_string_$skill(_templateObject120 || (_templateObject120 = smolrunleg_taggedTemplateLiteral(["Aug. 13th: Left/Off Hander's Day!"])))) || lib_have(template_string_$effect(_templateObject121 || (_templateObject121 = smolrunleg_taggedTemplateLiteral(["Offhand Remarkable"])))) || property_get("_aug13Cast", false),
      do: () =>
      // eslint-disable-next-line libram/verify-constants
      (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject122 || (_templateObject122 = smolrunleg_taggedTemplateLiteral(["Aug. 13th: Left/Off Hander's Day!"]))))
    }, {
      name: "Pajamas",
      completed: () => lib_have(template_string_$item(_templateObject123 || (_templateObject123 = smolrunleg_taggedTemplateLiteral(["burning cape"])))),
      acquire: [{
        item: template_string_$item(_templateObject124 || (_templateObject124 = smolrunleg_taggedTemplateLiteral(["clockwork maid"]))),
        price: 7 * property_get("valueOfAdventure"),
        optional: true
      }, {
        item: template_string_$item(_templateObject125 || (_templateObject125 = smolrunleg_taggedTemplateLiteral(["burning cape"])))
      }],
      do: () => {
        if (lib_have(template_string_$item(_templateObject126 || (_templateObject126 = smolrunleg_taggedTemplateLiteral(["clockwork maid"]))))) {
          (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject127 || (_templateObject127 = smolrunleg_taggedTemplateLiteral(["clockwork maid"]))));
        }
        smolrunleg_pajamas = true;
      },
      outfit: () => ({
        familiar: template_string_$familiars(_templateObject128 || (_templateObject128 = smolrunleg_taggedTemplateLiteral(["Trick-or-Treating Tot, Left-Hand Man, Disembodied Hand, Grey Goose"]))).find(fam => lib_have(fam)),
        modifier: "adventures".concat(args.pvp ? ", 0.3 fites" : "")
      })
    }, {
      name: "Summon Soap Knife",
      completed: () => !lib_have(template_string_$skill(_templateObject129 || (_templateObject129 = smolrunleg_taggedTemplateLiteral(["That's Not a Knife"])))) || property_get("_discoKnife"),
      prepare: () => (0,external_kolmafia_namespaceObject.putCloset)((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject130 || (_templateObject130 = smolrunleg_taggedTemplateLiteral(["soap knife"])))), template_string_$item(_templateObject131 || (_templateObject131 = smolrunleg_taggedTemplateLiteral(["soap knife"])))),
      do: () => (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject132 || (_templateObject132 = smolrunleg_taggedTemplateLiteral(["That's Not a Knife"])))),
      post: () => (0,external_kolmafia_namespaceObject.takeCloset)((0,external_kolmafia_namespaceObject.closetAmount)(template_string_$item(_templateObject133 || (_templateObject133 = smolrunleg_taggedTemplateLiteral(["soap knife"])))), template_string_$item(_templateObject134 || (_templateObject134 = smolrunleg_taggedTemplateLiteral(["soap knife"]))))
    }, {
      name: "Alert-No Nightcap",
      ready: () => !doneAdventuring(),
      completed: () => stooperDrunk(),
...
function GarboWeenQuest() {
  return {
    ...
    tasks: [{
      ...
      name: "Consume Eldritch Attunement",
      completed: () => lib_have(template_string_$effect(Garboween_templateObject44 || (Garboween_templateObject44 = Garboween_taggedTemplateLiteral(["Eldritch Attunement"])))),
      do: () => {
        var source = new Map([[template_string_$item(Garboween_templateObject45 || (Garboween_templateObject45 = Garboween_taggedTemplateLiteral(["eldritch elixir"]))), (0,external_kolmafia_namespaceObject.mallPrice)(template_string_$item(Garboween_templateObject46 || (Garboween_templateObject46 = Garboween_taggedTemplateLiteral(["eldritch elixir"]))))], [template_string_$item(Garboween_templateObject47 || (Garboween_templateObject47 = Garboween_taggedTemplateLiteral(["Eldritch snap"]))), (0,external_kolmafia_namespaceObject.mallPrice)(template_string_$item(Garboween_templateObject48 || (Garboween_templateObject48 = Garboween_taggedTemplateLiteral(["Eldritch snap"]))))], [template_string_$item(Garboween_templateObject49 || (Garboween_templateObject49 = Garboween_taggedTemplateLiteral(["eldritch mushroom pizza"]))), (0,external_kolmafia_namespaceObject.mallPrice)(template_string_$item(Garboween_templateObject50 || (Garboween_templateObject50 = Garboween_taggedTemplateLiteral(["eldritch mushroom pizza"])))) - .5 * (0,external_kolmafia_namespaceObject.mallPrice)(template_string_$item(Garboween_templateObject51 || (Garboween_templateObject51 = Garboween_taggedTemplateLiteral(["eldritch mushroom"]))))]]);
        var minPriceItem;
        var minPrice = 0;
        var _iterator = Garboween_createForOfIteratorHelper(source),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var _step$value = Garboween_slicedToArray(_step.value, 2),
              item = _step$value[0],
              price = _step$value[1];
            if (price < minPrice) {
              minPrice = price;
        ...
        (0,external_kolmafia_namespaceObject.cliExecute)("acquire ".concat(minPriceItem, "; eat ").concat(minPriceItem));
      }
    }, {
      name: "CONSUME ALL",
      completed: () => (0,external_kolmafia_namespaceObject.myFullness)() >= (0,external_kolmafia_namespaceObject.fullnessLimit)() && (0,external_kolmafia_namespaceObject.mySpleenUse)() >= (0,external_kolmafia_namespaceObject.spleenLimit)() && (0,external_kolmafia_namespaceObject.myInebriety)() >= (0,external_kolmafia_namespaceObject.inebrietyLimit)(),
      ...
      prepare: () => uneffect(template_string_$effect(Garboween_templateObject52 || (Garboween_templateObject52 = Garboween_taggedTemplateLiteral(["Beaten Up"])))),
      do: () => {
        if (lib_have(template_string_$familiar(Garboween_templateObject53 || (Garboween_templateObject53 = Garboween_taggedTemplateLiteral(["Trick-or-Treating Tot"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("familiar Trick-or-Treating Tot");else if (lib_have(template_string_$familiar(Garboween_templateObject54 || (Garboween_templateObject54 = Garboween_taggedTemplateLiteral(["Red-Nosed Snapper"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("familiar snapper");
        (0,external_kolmafia_namespaceObject.cliExecute)("freecandy ".concat((0,external_kolmafia_namespaceObject.myAdventures)()));
      },
      clear: "all",
      tracking: "Freecandy",
      ...
      name: "Do Pizza",
      completed: () => lib_have(template_string_$item(Garboween_templateObject55 || (Garboween_templateObject55 = Garboween_taggedTemplateLiteral(["Pizza of Legend"])))) && lib_have(template_string_$item(Garboween_templateObject56 || (Garboween_templateObject56 = Garboween_taggedTemplateLiteral(["Deep Dish of Legend"])))) && lib_have(template_string_$item(Garboween_templateObject57 || (Garboween_templateObject57 = Garboween_taggedTemplateLiteral(["Calzone of Legend"])))),
      do: () => {
        !lib_have(template_string_$item(Garboween_templateObject58 || (Garboween_templateObject58 = Garboween_taggedTemplateLiteral(["Pizza of Legend"])))) ? (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(Garboween_templateObject59 || (Garboween_templateObject59 = Garboween_taggedTemplateLiteral(["Pizza of Legend"])))) : undefined;
        !lib_have(template_string_$item(Garboween_templateObject60 || (Garboween_templateObject60 = Garboween_taggedTemplateLiteral(["Deep Dish of Legend"])))) ? (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(Garboween_templateObject61 || (Garboween_templateObject61 = Garboween_taggedTemplateLiteral(["Deep Dish of Legend"])))) : undefined;
        !lib_have(template_string_$item(Garboween_templateObject62 || (Garboween_templateObject62 = Garboween_taggedTemplateLiteral(["Calzone of Legend"])))) ? (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(Garboween_templateObject63 || (Garboween_templateObject63 = Garboween_taggedTemplateLiteral(["Calzone of Legend"])))) : undefined;
      }
    }, {
      name: "Stooper",
      ready: () => (0,external_kolmafia_namespaceObject.myInebriety)() === (0,external_kolmafia_namespaceObject.inebrietyLimit)() && lib_have(template_string_$item(Garboween_templateObject64 || (Garboween_templateObject64 = Garboween_taggedTemplateLiteral(["tiny stillsuit"])))) && property_get("familiarSweat") >= 300,
      completed: () => !lib_have(template_string_$familiar(Garboween_templateObject65 || (Garboween_templateObject65 = Garboween_taggedTemplateLiteral(["Stooper"])))) || stooperDrunk(),
      do: () => {
        (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(Garboween_templateObject66 || (Garboween_templateObject66 = Garboween_taggedTemplateLiteral(["Stooper"]))));
        (0,external_kolmafia_namespaceObject.cliExecute)("drink stillsuit distillate");
      }
    }, {
      name: "Super Nightcap",
      ready: () => lib_have(template_string_$item(Garboween_templateObject67 || (Garboween_templateObject67 = Garboween_taggedTemplateLiteral(["Drunkula's wineglass"])))),
      completed: () => totallyDrunk(),
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("CONSUME NIGHTCAP")
    }, {
      name: "Freecandy Drunk",
      ...
      prepare: () => uneffect(template_string_$effect(Garboween_templateObject68 || (Garboween_templateObject68 = Garboween_taggedTemplateLiteral(["Beaten Up"])))),
      do: () => {
        (0,external_kolmafia_namespaceObject.cliExecute)("freeCandy ".concat((0,external_kolmafia_namespaceObject.myAdventures)()));
      },
      clear: "all",
      ...
      name: "Grimace Maps",
      ready: () => lib_have(template_string_$item(Garboween_templateObject69 || (Garboween_templateObject69 = Garboween_taggedTemplateLiteral(["Map to Safety Shelter Grimace Prime"])))) && totallyDrunk(),
      completed: () => !lib_have(template_string_$item(Garboween_templateObject70 || (Garboween_templateObject70 = Garboween_taggedTemplateLiteral(["Map to Safety Shelter Grimace Prime"])))) || (0,external_kolmafia_namespaceObject.myAdventures)() === 0,
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("grimace maps")
    }, {
      name: "Comb Beach",
      ready: () => lib_have(template_string_$item(Garboween_templateObject71 || (Garboween_templateObject71 = Garboween_taggedTemplateLiteral(["Beach Comb"])))) && totallyDrunk(),
      completed: () => (0,external_kolmafia_namespaceObject.myAdventures)() === 0,
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("combo ".concat(11 - property_get("_freeBeachWalksUsed") + (0,external_kolmafia_namespaceObject.myAdventures)()))
    }, {
      name: "Turn in FunFunds",
      ready: () => property_get("_stenchAirportToday") && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(Garboween_templateObject72 || (Garboween_templateObject72 = Garboween_taggedTemplateLiteral(["FunFunds\u2122"])))) >= 20,
      completed: () => lib_have(template_string_$item(Garboween_templateObject73 || (Garboween_templateObject73 = Garboween_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
      do: () => (0,external_kolmafia_namespaceObject.buy)($coinmaster(Garboween_templateObject74 || (Garboween_templateObject74 = Garboween_taggedTemplateLiteral(["The Dinsey Company Store"]))), 1, template_string_$item(Garboween_templateObject75 || (Garboween_templateObject75 = Garboween_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
      tracking: "Garbo"
    }, {
      name: "PvP",
      completed: () => (0,external_kolmafia_namespaceObject.pvpAttacksLeft)() === 0 || !(0,external_kolmafia_namespaceObject.hippyStoneBroken)(),
...
var tasks_ascend_templateObject, tasks_ascend_templateObject2, tasks_ascend_templateObject3, tasks_ascend_templateObject4, tasks_ascend_templateObject5, tasks_ascend_templateObject6, tasks_ascend_templateObject7;
  ...
  return {
    ...
    tasks: [{
      ...
      do: () => {
        ...
        var path = args.cs ? $path(tasks_ascend_templateObject4 || (tasks_ascend_templateObject4 = tasks_ascend_taggedTemplateLiteral(["Community Service"]))) : args.smol ? $path(tasks_ascend_templateObject5 || (tasks_ascend_templateObject5 = tasks_ascend_taggedTemplateLiteral(["A Shrunken Adventurer am I"]))) : undefined;
        ...
        ascend({
          ...
          lifestyle: 2,
          moon: moonsign,
          consumable: template_string_$item(tasks_ascend_templateObject6 || (tasks_ascend_templateObject6 = tasks_ascend_taggedTemplateLiteral(["astral six-pack"]))),
          pet: args.astralpet === template_string_$item(tasks_ascend_templateObject7 || (tasks_ascend_templateObject7 = tasks_ascend_taggedTemplateLiteral(["none"]))) ? undefined : args.astralpet,
          permOptions: {
...
function main(command) {
  ...
  var runQuest = args.cs ? CSQuests() : args.smol ? SmolQuests() : undefined;
