...
function CSQuests() {
  return [{
    ...
    tasks: [{
      ...
      do: () => {
        var smoke = 1;
        while (lib_have(template_string_$item(csleg_templateObject5 || (csleg_templateObject5 = csleg_taggedTemplateLiteral(["stick of firewood"]))))) {
          ...
          (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(csleg_templateObject6 || (csleg_templateObject6 = csleg_taggedTemplateLiteral(["campfire smoke"]))));
          smoke = smoke + 1;
        }
      }
    }, {
      name: "Acquire Carpe",
      completed: () => !args.carpe || lib_have(template_string_$item(csleg_templateObject7 || (csleg_templateObject7 = csleg_taggedTemplateLiteral(["carpe"])))),
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("acquire carpe")
    }, {
      name: "Unlock Desert",
      completed: () => lib_have(template_string_$item(csleg_templateObject8 || (csleg_templateObject8 = csleg_taggedTemplateLiteral(["bitchin' meatcar"])))),
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("acquire bitchin")
    }, {
      name: "Drink Pre-Tune",
      ready: () => (0,external_kolmafia_namespaceObject.mySign)().toLowerCase() === "blender" && (0,external_kolmafia_namespaceObject.myLevel)() >= 7 && lib_have(template_string_$item(csleg_templateObject9 || (csleg_templateObject9 = csleg_taggedTemplateLiteral(["mime army shotglass"])))) && (lib_have(template_string_$item(csleg_templateObject10 || (csleg_templateObject10 = csleg_taggedTemplateLiteral(["astral pilsner"])))) || lib_have(template_string_$item(csleg_templateObject11 || (csleg_templateObject11 = csleg_taggedTemplateLiteral(["astral six-pack"]))))),
      completed: () => property_get("_mimeArmyShotglassUsed") || !lib_have(template_string_$item(csleg_templateObject12 || (csleg_templateObject12 = csleg_taggedTemplateLiteral(["hewn moon-rune spoon"])))) || property_get("moonTuned"),
      prepare: () => {
        if (lib_have(template_string_$item(csleg_templateObject13 || (csleg_templateObject13 = csleg_taggedTemplateLiteral(["astral six-pack"]))))) (0,external_kolmafia_namespaceObject.use)(template_string_$item(csleg_templateObject14 || (csleg_templateObject14 = csleg_taggedTemplateLiteral(["astral six-pack"]))));
      },
      do: () => (0,external_kolmafia_namespaceObject.drink)(1, template_string_$item(csleg_templateObject15 || (csleg_templateObject15 = csleg_taggedTemplateLiteral(["astral pilsner"]))))
    }, {
      name: "Moon Spoon",
      completed: () => !lib_have(template_string_$item(csleg_templateObject16 || (csleg_templateObject16 = csleg_taggedTemplateLiteral(["hewn moon-rune spoon"])))) || property_get("moonTuned") || (0,external_kolmafia_namespaceObject.mySign)().toLowerCase() === "wombat",
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("spoon wombat")
    }, {
      name: "Drive Observantly",
      completed: () => (0,external_kolmafia_namespaceObject.getWorkshed)() !== template_string_$item(csleg_templateObject17 || (csleg_templateObject17 = csleg_taggedTemplateLiteral(["Asdon Martin keyfob"]))) || (0,external_kolmafia_namespaceObject.haveEffect)(template_string_$effect(csleg_templateObject18 || (csleg_templateObject18 = csleg_taggedTemplateLiteral(["Driving Observantly"])))) >= (totallyDrunk() || !lib_have(template_string_$item(csleg_templateObject19 || (csleg_templateObject19 = csleg_taggedTemplateLiteral(["Drunkula's wineglass"])))) ? (0,external_kolmafia_namespaceObject.myAdventures)() : (0,external_kolmafia_namespaceObject.myAdventures)() + 60),
      do: () => drive(template_string_$effect(csleg_templateObject20 || (csleg_templateObject20 = csleg_taggedTemplateLiteral(["Driving Observantly"]))), totallyDrunk() || !lib_have(template_string_$item(csleg_templateObject21 || (csleg_templateObject21 = csleg_taggedTemplateLiteral(["Drunkula's wineglass"])))) ? (0,external_kolmafia_namespaceObject.myAdventures)() : (0,external_kolmafia_namespaceObject.myAdventures)() + 60, false),
      limit: {
        tries: 5
      }
    }, {
      ...
      prepare: () => uneffect(template_string_$effect(csleg_templateObject22 || (csleg_templateObject22 = csleg_taggedTemplateLiteral(["Beaten Up"])))),
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)(args.garbo),
      post: () => $effects(csleg_templateObject23 || (csleg_templateObject23 = csleg_taggedTemplateLiteral(["Power Ballad of the Arrowsmith, Stevedave's Shanty of Superiority, The Moxious Madrigal, The Magical Mojomuscular Melody, Aloysius' Antiphon of Aptitude, Ur-Kel's Aria of Annoyance"]))).filter(ef => lib_have(ef)).forEach(ef => uneffect(ef)),
      clear: "all",
      tracking: "Garbo"
    }, {
      name: "Garboween",
      ready: () => (0,external_kolmafia_namespaceObject.holiday)().includes("Halloween"),
      completed: () => stooperDrunk() || !canDiet() && (0,external_kolmafia_namespaceObject.myAdventures)() === 0,
      prepare: () => uneffect(template_string_$effect(csleg_templateObject24 || (csleg_templateObject24 = csleg_taggedTemplateLiteral(["Beaten Up"])))),
      do: () => {
      ...
      name: "Turn in FunFunds",
      ready: () => property_get("_stenchAirportToday") && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(csleg_templateObject26 || (csleg_templateObject26 = csleg_taggedTemplateLiteral(["FunFunds\u2122"])))) >= 20,
      completed: () => lib_have(template_string_$item(csleg_templateObject27 || (csleg_templateObject27 = csleg_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
      do: () => (0,external_kolmafia_namespaceObject.buy)($coinmaster(csleg_templateObject28 || (csleg_templateObject28 = csleg_taggedTemplateLiteral(["The Dinsey Company Store"]))), 1, template_string_$item(csleg_templateObject29 || (csleg_templateObject29 = csleg_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
      tracking: "Garbo"
    }, {
      name: "PvP",
      ...
      name: "Stooper",
      ready: () => (0,external_kolmafia_namespaceObject.myInebriety)() === (0,external_kolmafia_namespaceObject.inebrietyLimit)() && lib_have(template_string_$item(csleg_templateObject30 || (csleg_templateObject30 = csleg_taggedTemplateLiteral(["tiny stillsuit"])))) && property_get("familiarSweat") >= 300,
      completed: () => !lib_have(template_string_$familiar(csleg_templateObject31 || (csleg_templateObject31 = csleg_taggedTemplateLiteral(["Stooper"])))) || stooperDrunk(),
      do: () => {
        (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(csleg_templateObject32 || (csleg_templateObject32 = csleg_taggedTemplateLiteral(["Stooper"]))));
        (0,external_kolmafia_namespaceObject.cliExecute)("drink stillsuit distillate");
      }
    }, {
      name: "Nightcap",
      ...
      name: "Do Pizza",
      ready: () => doneAdventuring(),
      completed: () => lib_have(template_string_$item(csleg_templateObject33 || (csleg_templateObject33 = csleg_taggedTemplateLiteral(["Pizza of Legend"])))) && lib_have(template_string_$item(csleg_templateObject34 || (csleg_templateObject34 = csleg_taggedTemplateLiteral(["Deep Dish of Legend"])))) && lib_have(template_string_$item(csleg_templateObject35 || (csleg_templateObject35 = csleg_taggedTemplateLiteral(["Calzone of Legend"])))),
      do: () => {
        !lib_have(template_string_$item(csleg_templateObject36 || (csleg_templateObject36 = csleg_taggedTemplateLiteral(["Pizza of Legend"])))) ? (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(csleg_templateObject37 || (csleg_templateObject37 = csleg_taggedTemplateLiteral(["Pizza of Legend"])))) : undefined;
        !lib_have(template_string_$item(csleg_templateObject38 || (csleg_templateObject38 = csleg_taggedTemplateLiteral(["Deep Dish of Legend"])))) ? (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(csleg_templateObject39 || (csleg_templateObject39 = csleg_taggedTemplateLiteral(["Deep Dish of Legend"])))) : undefined;
        !lib_have(template_string_$item(csleg_templateObject40 || (csleg_templateObject40 = csleg_taggedTemplateLiteral(["Calzone of Legend"])))) ? (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(csleg_templateObject41 || (csleg_templateObject41 = csleg_taggedTemplateLiteral(["Calzone of Legend"])))) : undefined;
      }
    }, {
      name: "Plant Garden",
      ready: () => doneAdventuring() && !!template_string_$items(csleg_templateObject42 || (csleg_templateObject42 = csleg_taggedTemplateLiteral(["packet of rock seeds, packet of thanksgarden seeds, Peppermint Pip Packet, packet of winter seeds, packet of beer seeds, packet of pumpkin seeds, packet of dragon's teeth"]))).find(it => lib_have(it)),
      completed: () => getGarden() !== template_string_$item(csleg_templateObject43 || (csleg_templateObject43 = csleg_taggedTemplateLiteral(["packet of tall grass seeds"]))),
      do: () => {
        (0,external_kolmafia_namespaceObject.use)(template_string_$items(csleg_templateObject44 || (csleg_templateObject44 = csleg_taggedTemplateLiteral(["packet of rock seeds, packet of thanksgarden seeds, Peppermint Pip Packet, packet of winter seeds, packet of beer seeds, packet of pumpkin seeds, packet of dragon's teeth"]))).find(it => lib_have(it)) || template_string_$item(csleg_templateObject45 || (csleg_templateObject45 = csleg_taggedTemplateLiteral(["none"]))));
      ...
      ready: () => (0,external_kolmafia_namespaceObject.holiday)().includes("Halloween"),
      completed: () => stooperDrunk() || !canDiet() && (0,external_kolmafia_namespaceObject.myAdventures)() === 0,
      prepare: () => uneffect(template_string_$effect(csleg_templateObject46 || (csleg_templateObject46 = csleg_taggedTemplateLiteral(["Beaten Up"])))),
      do: () => {
        (0,external_kolmafia_namespaceObject.cliExecute)("freeCandy ".concat((0,external_kolmafia_namespaceObject.myAdventures)()));
      },
      post: () => {
        if ((0,external_kolmafia_namespaceObject.myAdventures)() === 0) $effects(csleg_templateObject47 || (csleg_templateObject47 = csleg_taggedTemplateLiteral(["Power Ballad of the Arrowsmith, Stevedave's Shanty of Superiority, The Moxious Madrigal, The Magical Mojomuscular Melody, Aloysius' Antiphon of Aptitude, Ur-Kel's Aria of Annoyance"]))).filter(ef => lib_have(ef)).forEach(ef => uneffect(ef));
      },
      clear: "all",
      tracking: "Garbo",
      limit: {
      ...
      // eslint-disable-next-line libram/verify-constants
      ready: () => lib_have(template_string_$item(csleg_templateObject48 || (csleg_templateObject48 = csleg_taggedTemplateLiteral(["august scepter"])))),
      // eslint-disable-next-line libram/verify-constants
      completed: () => lib_have(template_string_$effect(csleg_templateObject49 || (csleg_templateObject49 = csleg_taggedTemplateLiteral(["Offhand Remarkable"])))) || property_get("_aug13Cast", false),
      do: () =>
      // eslint-disable-next-line libram/verify-constants
      (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(csleg_templateObject50 || (csleg_templateObject50 = csleg_taggedTemplateLiteral(["Aug. 13th: Left/Off Hander's Day!"]))))
    }, {
      name: "Pajamas",
      completed: () => lib_have(template_string_$item(csleg_templateObject51 || (csleg_templateObject51 = csleg_taggedTemplateLiteral(["burning cape"])))),
      acquire: [{
        item: template_string_$item(csleg_templateObject52 || (csleg_templateObject52 = csleg_taggedTemplateLiteral(["clockwork maid"]))),
        price: 7 * property_get("valueOfAdventure"),
        optional: true
      }, {
        item: template_string_$item(csleg_templateObject53 || (csleg_templateObject53 = csleg_taggedTemplateLiteral(["burning cape"])))
      }],
      do: () => {
        if (lib_have(template_string_$item(csleg_templateObject54 || (csleg_templateObject54 = csleg_taggedTemplateLiteral(["clockwork maid"]))))) {
          (0,external_kolmafia_namespaceObject.use)(template_string_$item(csleg_templateObject55 || (csleg_templateObject55 = csleg_taggedTemplateLiteral(["clockwork maid"]))));
        }
        pajamas = true;
      },
      outfit: () => ({
        familiar: template_string_$familiars(csleg_templateObject56 || (csleg_templateObject56 = csleg_taggedTemplateLiteral(["Trick-or-Treating Tot, Left-Hand Man, Disembodied Hand, Grey Goose"]))).find(fam => lib_have(fam)),
