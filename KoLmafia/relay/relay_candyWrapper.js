 ...
 * @category In-game constant
 */
var template_string_$location = createSingleConstant(external_kolmafia_.Location, external_kolmafia_.toLocation);
/**
 ...
 * @category In-game constant
 */
var template_string_$monster = createSingleConstant(external_kolmafia_.Monster, external_kolmafia_.toMonster);
/**
 ...
 * @category In-game constant
 */
var template_string_$phylum = createSingleConstant(external_kolmafia_.Phylum, external_kolmafia_.toPhylum);
/**
...
function totalFamiliarWeight() {
  ...
  return clamp(clamp(familiarWeight(familiar), lib_have($effect(_templateObject49 || (_templateObject49 = _taggedTemplateLiteral(["Fidoxene"])))) ? 20 : 0, Infinity) + familiar.soupWeight + (considerAdjustment ? weightAdjustment() : 0) + (familiar.feasted ? 10 : 0), 1, Infinity);
}
...
var StrictMacro = /*#__PURE__*/(/* unused pure expression or super */ null && (function (_Macro) {
  ...
  combat_createClass(StrictMacro, [{
    ...
    function funkslingItem() {
      ...
      return (_get6 = combat_get(combat_getPrototypeOf(StrictMacro.prototype), "funkslingItem", this)).call.apply(_get6, [this].concat(items));
    }
    /**
     * Create a new macro with one or more item steps, and automatically attempting to funksling as many of the items as possible.
     * This function does not check if you can funksling or not.
    ...
    function tryFunkslingItem() {
      ...
      return (_get7 = combat_get(combat_getPrototypeOf(StrictMacro.prototype), "tryFunkslingItem", this)).call.apply(_get7, [this].concat(items));
    }
    /**
     * Create a new macro with one or more item steps, where each step checks to see if you have the item first,
     * and automatically attempting to funksling as many of the items as possible.
    ...
    function trySkillRepeat() {
      ...
      return (_get8 = combat_get(combat_getPrototypeOf(StrictMacro.prototype), "trySkillRepeat", this)).call.apply(_get8, [this].concat(skills));
    }
    /**
     * Create a new macro with one or more skill-cast-and-repeat steps, where each step checks if you have the skill first.
     *
  ...
  outfit_createClass(Outfit, [{
    ...
    value: function spec() {
      ...
      for (var _i6 = 0, _outfitSlots2 = outfitSlots; _i6 < _outfitSlots2.length; _i6++) {
        ...
        var entry = this.equips.get((_a = new Map([["famequip", $slot(outfit_templateObject52 || (outfit_templateObject52 = outfit_taggedTemplateLiteral(["familiar"])))], ["offhand", $slot(outfit_templateObject53 || (outfit_templateObject53 = outfit_taggedTemplateLiteral(["off-hand"])))]]).get(slotName)) !== null && _a !== void 0 ? _a : (0,external_kolmafia_.toSlot)(slotName));
...
function getCurrentSession() {
  ...
  var itemMappings = new Map([].concat(profits_toConsumableArray(foldable($item(profits_templateObject48 || (profits_templateObject48 = profits_taggedTemplateLiteral(["liar's pants"]))))), profits_toConsumableArray(foldable($item(profits_templateObject49 || (profits_templateObject49 = profits_taggedTemplateLiteral(["ice pick"]))))), profits_toConsumableArray(manyToOne($item(profits_templateObject50 || (profits_templateObject50 = profits_taggedTemplateLiteral(["Spooky Putty sheet"]))), [$item(profits_templateObject51 || (profits_templateObject51 = profits_taggedTemplateLiteral(["Spooky Putty monster"])))].concat(profits_toConsumableArray(getFoldGroup($item(profits_templateObject52 || (profits_templateObject52 = profits_taggedTemplateLiteral(["Spooky Putty sheet"])))))))), profits_toConsumableArray(foldable($item(profits_templateObject53 || (profits_templateObject53 = profits_taggedTemplateLiteral(["stinky cheese sword"]))))), profits_toConsumableArray(foldable($item(profits_templateObject54 || (profits_templateObject54 = profits_taggedTemplateLiteral(["naughty paper shuriken"]))))), profits_toConsumableArray(foldable($item(profits_templateObject55 || (profits_templateObject55 = profits_taggedTemplateLiteral(["Loathing Legion knife"]))))), profits_toConsumableArray(foldable($item(profits_templateObject56 || (profits_templateObject56 = profits_taggedTemplateLiteral(["deceased crimbo tree"]))))), profits_toConsumableArray(foldable($item(profits_templateObject57 || (profits_templateObject57 = profits_taggedTemplateLiteral(["makeshift turban"]))))), profits_toConsumableArray(foldable($item(profits_templateObject58 || (profits_templateObject58 = profits_taggedTemplateLiteral(["turtle wax shield"]))))), profits_toConsumableArray(foldable($item(profits_templateObject59 || (profits_templateObject59 = profits_taggedTemplateLiteral(["metallic foil bow"]))))), profits_toConsumableArray(foldable($item(profits_templateObject60 || (profits_templateObject60 = profits_taggedTemplateLiteral(["ironic moustache"]))))), profits_toConsumableArray(foldable($item(profits_templateObject61 || (profits_templateObject61 = profits_taggedTemplateLiteral(["bugged balaclava"]))))), profits_toConsumableArray(foldable($item(_templateObject62 || (_templateObject62 = profits_taggedTemplateLiteral(["toggle switch (Bartend)"]))))), profits_toConsumableArray(foldable($item(_templateObject63 || (_templateObject63 = profits_taggedTemplateLiteral(["mushroom cap"]))))), profits_toConsumableArray(manyToOne($item(_templateObject64 || (_templateObject64 = profits_taggedTemplateLiteral(["can of Rain-Doh"]))), $items(_templateObject65 || (_templateObject65 = profits_taggedTemplateLiteral(["empty Rain-Doh can"]))))), profits_toConsumableArray(manyToOne($item(_templateObject66 || (_templateObject66 = profits_taggedTemplateLiteral(["meteorite fragment"]))), $items(_templateObject67 || (_templateObject67 = profits_taggedTemplateLiteral(["meteorite earring, meteorite necklace, meteorite ring"]))))), profits_toConsumableArray(manyToOne($item(_templateObject68 || (_templateObject68 = profits_taggedTemplateLiteral(["Sneaky Pete's leather jacket"]))), $items(_templateObject69 || (_templateObject69 = profits_taggedTemplateLiteral(["Sneaky Pete's leather jacket (collar popped)"]))))), profits_toConsumableArray(manyToOne($item(_templateObject70 || (_templateObject70 = profits_taggedTemplateLiteral(["Boris's Helm"]))), $items(_templateObject71 || (_templateObject71 = profits_taggedTemplateLiteral(["Boris's Helm (askew)"]))))), profits_toConsumableArray(manyToOne($item(_templateObject72 || (_templateObject72 = profits_taggedTemplateLiteral(["Jarlsberg's pan"]))), $items(_templateObject73 || (_templateObject73 = profits_taggedTemplateLiteral(["Jarlsberg's pan (Cosmic portal mode)"]))))), profits_toConsumableArray(manyToOne($item(_templateObject74 || (_templateObject74 = profits_taggedTemplateLiteral(["tiny plastic sword"]))), $items(_templateObject75 || (_templateObject75 = profits_taggedTemplateLiteral(["grogtini, bodyslam, dirty martini, vesper, cherry bomb, sangria del diablo"]))))), profits_toConsumableArray(manyToOne($item(_templateObject76 || (_templateObject76 = profits_taggedTemplateLiteral(["earthenware muffin tin"]))), $items(_templateObject77 || (_templateObject77 = profits_taggedTemplateLiteral(["blueberry muffin, bran muffin, chocolate chip muffin"])))))));
...
function canDiet() {
  return myFullness() < fullnessLimit() || mySpleenUse() < spleenLimit() || myInebriety() < inebrietyLimit() || have($item(utils_templateObject18 || (utils_templateObject18 = utils_taggedTemplateLiteral(["distention pill"])))) && !get("_distentionPillUsed") || args.smol || have($item(utils_templateObject19 || (utils_templateObject19 = utils_taggedTemplateLiteral(["synthetic dog hair pill"])))) && !get("_syntheticDogHairPillUsed") || have($item(utils_templateObject20 || (utils_templateObject20 = utils_taggedTemplateLiteral(["designer sweatpants"])))) && get("_sweatOutSomeBoozeUsed") < 3 && get("sweat") >= 25 || have($item(utils_templateObject21 || (utils_templateObject21 = utils_taggedTemplateLiteral(["mime army shotglass"])))) && !get("_mimeArmyShotglassUsed") || get("currentMojoFilters") < 3 && mallPrice($item(utils_templateObject22 || (utils_templateObject22 = utils_taggedTemplateLiteral(["mojo filter"])))) + mallPrice($item(utils_templateObject23 || (utils_templateObject23 = utils_taggedTemplateLiteral(["transdermal smoke patch"])))) < 2.5 * get("valueOfAdventure");
}
function stooperDrunk() {
  return myInebriety() > inebrietyLimit() || myInebriety() === inebrietyLimit() && myFamiliar() === $familiar(utils_templateObject24 || (utils_templateObject24 = utils_taggedTemplateLiteral(["Stooper"])));
}
function totallyDrunk() {
  return have($familiar(utils_templateObject25 || (utils_templateObject25 = utils_taggedTemplateLiteral(["Stooper"])))) && myFamiliar() !== $familiar(utils_templateObject26 || (utils_templateObject26 = utils_taggedTemplateLiteral(["Stooper"]))) ? myInebriety() > inebrietyLimit() + 1 : myInebriety() > inebrietyLimit();
}
...
function getGarden() {
  return gardens.find(it => it.name in getCampground()) || $item(utils_templateObject28 || (utils_templateObject28 = utils_taggedTemplateLiteral(["none"])));
}
var banishes;
...
function backstageItemsDone() {
  return (have($item(utils_templateObject35 || (utils_templateObject35 = utils_taggedTemplateLiteral(["giant marshmallow"])))) ? 1 : 0) + (have($item(utils_templateObject36 || (utils_templateObject36 = utils_taggedTemplateLiteral(["beer-scented teddy bear"])))) ? 1 : 0) + itemAmount($item(utils_templateObject37 || (utils_templateObject37 = utils_taggedTemplateLiteral(["gin-soaked blotter paper"])))) >= 2 && (have($item(utils_templateObject38 || (utils_templateObject38 = utils_taggedTemplateLiteral(["booze-soaked cherry"])))) ? 1 : 0) + (have($item(utils_templateObject39 || (utils_templateObject39 = utils_taggedTemplateLiteral(["comfy pillow"])))) ? 1 : 0) + itemAmount($item(utils_templateObject40 || (utils_templateObject40 = utils_taggedTemplateLiteral(["sponge cake"])))) >= 2;
}
function notifyVoters() {
  ...
  var message = "Voter Monster Today is ".concat(get("_voteMonster"));
...
var halloween = ((0,external_kolmafia_.gamedayToInt)() === 79 || realMonth === 10 && realDay === 31 || (0,external_kolmafia_.holiday)().includes("halloween")) && isHalloweenWorthDoing();
function pvpCloset(num) {
  var threshold = 10000;
  $items(utils_templateObject41 || (utils_templateObject41 = utils_taggedTemplateLiteral([""]))).filter(it => itemAmount(it) > 0 && it.tradeable && it.discardable && !it.quest && !it.gift && mallPrice(it) >= threshold).forEach(it => {
...
function treatValue(outfit) {
  return sum(Object.entries((0,external_kolmafia_.outfitTreats)(outfit)), _ref => {
    var _ref2 = utils_slicedToArray(_ref, 2),
      candyName = _ref2[0],
      probability = _ref2[1];
    return probability * profits_garboValue((0,external_kolmafia_.toItem)(candyName));
  });
}
function getTreatOutfit() {
  var outfit = property_get("freecandy_treatOutfit");
  var availableOutfits = (0,external_kolmafia_.getOutfits)().filter(name => (0,external_kolmafia_.outfitPieces)(name).every(piece => (0,external_kolmafia_.canEquip)(piece)));
...
function baseAdventureValue() {
  if (!_baseAdventureValue) {
    ...
    var bowlValue = 1 / 5 * profits_garboValue(template_string_$item(utils_templateObject43 || (utils_templateObject43 = utils_taggedTemplateLiteral(["huge bowl of candy"]))));
    var prunetsValue = lib_have(template_string_$familiar(utils_templateObject44 || (utils_templateObject44 = utils_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) ? 4 * 0.2 * profits_garboValue(template_string_$item(utils_templateObject45 || (utils_templateObject45 = utils_taggedTemplateLiteral(["Prunets"])))) : 0;
...
function shouldWeOverdrink() {
  var overdrinkValue = get("valueOfAdventure") * (110 - 5.5 * 5) + mallPrice($item(utils_templateObject47 || (utils_templateObject47 = utils_taggedTemplateLiteral(["Sacramento wine"])))) * 5;
  var numToCleanse = 5;
  var sweatpants = have($item(utils_templateObject48 || (utils_templateObject48 = utils_taggedTemplateLiteral(["designer sweatpants"])))) ? 3 : 0;
  var drinking = have($skill(utils_templateObject49 || (utils_templateObject49 = utils_taggedTemplateLiteral(["Drinking to Drink"])))) ? 1 : 0;
  var doghair = storageAmount($item(utils_templateObject50 || (utils_templateObject50 = utils_taggedTemplateLiteral(["synthetic dog hair pill"])))) >= 1 ? 1 : 0;
  var checkMelange = () => get("valueOfAdventure") * 45 > mallPrice($item(utils_templateObject51 || (utils_templateObject51 = utils_taggedTemplateLiteral(["spice melange"])))) && sweatpants < 3;
  var melange = checkMelange() ? 3 : 0;
  var melangeCost = () => checkMelange() ? mallPrice($item(utils_templateObject52 || (utils_templateObject52 = utils_taggedTemplateLiteral(["spice melange"])))) : 0;
  if (sweatpants + drinking + doghair + melange >= numToCleanse && overdrinkValue > 0) {
    return true;
  } else {
    var sobrie = 1;
    if (sweatpants + drinking + doghair + sobrie + melange >= numToCleanse && overdrinkValue - mallPrice($item(utils_templateObject53 || (utils_templateObject53 = utils_taggedTemplateLiteral(["cuppa Sobrie tea"])))) - melangeCost() > 0) {
      return true;
    } else return false;
  }
}
function pantogramReady() {
  ...
  var pantogramValue = 100 * myAdventures();
  var cloverPrice = Math.min.apply(Math, utils_toConsumableArray($items(utils_templateObject54 || (utils_templateObject54 = utils_taggedTemplateLiteral(["ten-leaf clover, disassembled clover"]))).map(item => mallPrice(item))));
  if (cloverPrice + mallPrice($item(utils_templateObject55 || (utils_templateObject55 = utils_taggedTemplateLiteral(["porquoise"])))) > pantogramValue) {
    return false;
  }
  retrieveItem($item(utils_templateObject56 || (utils_templateObject56 = utils_taggedTemplateLiteral(["porquoise"]))), 1);
  if (!have($item(utils_templateObject57 || (utils_templateObject57 = utils_taggedTemplateLiteral(["porquoise"]))))) return false;
  return true;
}
function pantogram() {
  if (!Pantogram.have() || Pantogram.havePants()) return true;
  retrieveItem($item(utils_templateObject58 || (utils_templateObject58 = utils_taggedTemplateLiteral(["ten-leaf clover"]))));
  retrieveItem($item(utils_templateObject59 || (utils_templateObject59 = utils_taggedTemplateLiteral(["bubblin' crude"]))));
  Pantogram.makePants(myPrimestat().toString(), "Sleaze Resistance: 2", "MP Regen Max: 15", "Drops Items: true", "Meat Drop: 60");
  return true;
}
function garboTarget() {
  var values = new Map([[$monster(utils_templateObject60 || (utils_templateObject60 = utils_taggedTemplateLiteral(["cockroach"]))), 5_000], [$monster(utils_templateObject61 || (utils_templateObject61 = utils_taggedTemplateLiteral(["Witchess Bishop"]))), mallPrice($item(utils_templateObject62 || (utils_templateObject62 = utils_taggedTemplateLiteral(["Sacramento wine"])))) * 0.9], [$monster(utils_templateObject63 || (utils_templateObject63 = utils_taggedTemplateLiteral(["Witchess Knight"]))), mallPrice($item(utils_templateObject64 || (utils_templateObject64 = utils_taggedTemplateLiteral(["jumping horseradish"])))) * 0.9]]);
  return utils_toConsumableArray(values.entries()).reduce((best, current) => current[1] > best[1] ? current : best)[0];
}
