...
function getCurrentSession() {
  ...
  */
  ...
  var itemMappings = new Map([].concat(profits_toConsumableArray(foldable($item(profits_templateObject46 || (profits_templateObject46 = profits_taggedTemplateLiteral(["liar's pants"]))))), profits_toConsumableArray(foldable($item(profits_templateObject47 || (profits_templateObject47 = profits_taggedTemplateLiteral(["ice pick"]))))), profits_toConsumableArray(manyToOne($item(profits_templateObject48 || (profits_templateObject48 = profits_taggedTemplateLiteral(["Spooky Putty sheet"]))), [$item(profits_templateObject49 || (profits_templateObject49 = profits_taggedTemplateLiteral(["Spooky Putty monster"])))].concat(profits_toConsumableArray(getFoldGroup($item(profits_templateObject50 || (profits_templateObject50 = profits_taggedTemplateLiteral(["Spooky Putty sheet"])))))))), profits_toConsumableArray(foldable($item(profits_templateObject51 || (profits_templateObject51 = profits_taggedTemplateLiteral(["stinky cheese sword"]))))), profits_toConsumableArray(foldable($item(profits_templateObject52 || (profits_templateObject52 = profits_taggedTemplateLiteral(["naughty paper shuriken"]))))), profits_toConsumableArray(foldable($item(profits_templateObject53 || (profits_templateObject53 = profits_taggedTemplateLiteral(["Loathing Legion knife"]))))), profits_toConsumableArray(foldable($item(profits_templateObject54 || (profits_templateObject54 = profits_taggedTemplateLiteral(["deceased crimbo tree"]))))), profits_toConsumableArray(foldable($item(profits_templateObject55 || (profits_templateObject55 = profits_taggedTemplateLiteral(["makeshift turban"]))))), profits_toConsumableArray(foldable($item(profits_templateObject56 || (profits_templateObject56 = profits_taggedTemplateLiteral(["turtle wax shield"]))))), profits_toConsumableArray(foldable($item(profits_templateObject57 || (profits_templateObject57 = profits_taggedTemplateLiteral(["metallic foil bow"]))))), profits_toConsumableArray(foldable($item(profits_templateObject58 || (profits_templateObject58 = profits_taggedTemplateLiteral(["ironic moustache"]))))), profits_toConsumableArray(foldable($item(profits_templateObject59 || (profits_templateObject59 = profits_taggedTemplateLiteral(["bugged balaclava"]))))), profits_toConsumableArray(foldable($item(profits_templateObject60 || (profits_templateObject60 = profits_taggedTemplateLiteral(["toggle switch (Bartend)"]))))), profits_toConsumableArray(foldable($item(profits_templateObject61 || (profits_templateObject61 = profits_taggedTemplateLiteral(["mushroom cap"]))))), profits_toConsumableArray(manyToOne($item(_templateObject62 || (_templateObject62 = profits_taggedTemplateLiteral(["can of Rain-Doh"]))), $items(_templateObject63 || (_templateObject63 = profits_taggedTemplateLiteral(["empty Rain-Doh can"]))))), profits_toConsumableArray(manyToOne($item(_templateObject64 || (_templateObject64 = profits_taggedTemplateLiteral(["meteorite fragment"]))), $items(_templateObject65 || (_templateObject65 = profits_taggedTemplateLiteral(["meteorite earring, meteorite necklace, meteorite ring"]))))), profits_toConsumableArray(manyToOne($item(_templateObject66 || (_templateObject66 = profits_taggedTemplateLiteral(["Sneaky Pete's leather jacket"]))), $items(_templateObject67 || (_templateObject67 = profits_taggedTemplateLiteral(["Sneaky Pete's leather jacket (collar popped)"]))))), profits_toConsumableArray(manyToOne($item(_templateObject68 || (_templateObject68 = profits_taggedTemplateLiteral(["Boris's Helm"]))), $items(_templateObject69 || (_templateObject69 = profits_taggedTemplateLiteral(["Boris's Helm (askew)"]))))), profits_toConsumableArray(manyToOne($item(_templateObject70 || (_templateObject70 = profits_taggedTemplateLiteral(["Jarlsberg's pan"]))), $items(_templateObject71 || (_templateObject71 = profits_taggedTemplateLiteral(["Jarlsberg's pan (Cosmic portal mode)"]))))), profits_toConsumableArray(manyToOne($item(_templateObject72 || (_templateObject72 = profits_taggedTemplateLiteral(["tiny plastic sword"]))), $items(_templateObject73 || (_templateObject73 = profits_taggedTemplateLiteral(["grogtini, bodyslam, dirty martini, vesper, cherry bomb, sangria del diablo"]))))), profits_toConsumableArray(manyToOne($item(_templateObject74 || (_templateObject74 = profits_taggedTemplateLiteral(["earthenware muffin tin"]))), $items(_templateObject75 || (_templateObject75 = profits_taggedTemplateLiteral(["blueberry muffin, bran muffin, chocolate chip muffin"])))))));
